    ...
    internal class RARCPacker
    {
        ...
        public static void PackArchive(string srcDir, string dstDir, bool deleteDirectory)
        {
            ...
            header.stringTableOffset =
                header.fileEntriesOffset + (uint)((totalNumFilesAdded * 20) + x);
        ...
        static void CreateDummyFiles()
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    fileEntries[totalNumFilesAdded].filenameHash = Hash(
                        Convert.ToString(stringTable[0])
                    );
        ...
        {
            string dirName = new FileInfo(folder).Name;
            ...
            string[] numFiles = Directory.GetFileSystemEntries(folder);
