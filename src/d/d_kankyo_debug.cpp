...
void dKydb_color_HIO_update()
{
    ...
    add_update_proc(&g_kankyoHIO.light.field_0x60,
                    &g_env_light.actor_amb_col.r,
                    &g_env_light.actor_amb_col.g,
                    &g_env_light.actor_amb_col.b);
    add_update_proc(&g_kankyoHIO.light.field_0x61,
                    &g_env_light.bg_amb_col[0].r,
                    &g_env_light.bg_amb_col[0].g,
                    &g_env_light.bg_amb_col[0].b);
    add_update_proc(&g_kankyoHIO.light.field_0x62,
                    &g_env_light.bg_amb_col[1].r,
                    &g_env_light.bg_amb_col[1].g,
                    &g_env_light.bg_amb_col[1].b);
    add_update_proc(&g_kankyoHIO.light.field_0x63,
                    &g_env_light.bg_amb_col[2].r,
                    &g_env_light.bg_amb_col[2].g,
                    &g_env_light.bg_amb_col[2].b);
    add_update_proc(&g_kankyoHIO.light.field_0x64,
                    &g_env_light.bg_amb_col[3].r,
                    &g_env_light.bg_amb_col[3].g,
                    &g_env_light.bg_amb_col[3].b);
    add_update_proc(&g_kankyoHIO.light.field_0x65, &g_env_light.fog_col.r, &g_env_light.fog_col.g, &g_env_light.fog_col.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x66,
                     &g_env_light.dungeonlight[0].mColor.r,
                     &g_env_light.dungeonlight[0].mColor.g,
                     &g_env_light.dungeonlight[0].mColor.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x67,
                     &g_env_light.dungeonlight[1].mColor.r,
                     &g_env_light.dungeonlight[1].mColor.g,
                     &g_env_light.dungeonlight[1].mColor.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x68,
                     &g_env_light.dungeonlight[2].mColor.r,
                     &g_env_light.dungeonlight[2].mColor.g,
                     &g_env_light.dungeonlight[2].mColor.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x69,
                     &g_env_light.dungeonlight[3].mColor.r,
                     &g_env_light.dungeonlight[3].mColor.g,
                     &g_env_light.dungeonlight[3].mColor.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x6a,
                     &g_env_light.dungeonlight[4].mColor.r,
                     &g_env_light.dungeonlight[4].mColor.g,
                     &g_env_light.dungeonlight[4].mColor.b);
    add_update_proc2(&g_kankyoHIO.light.field_0x6b,
                     &g_env_light.dungeonlight[5].mColor.r,
                     &g_env_light.dungeonlight[5].mColor.g,
                     &g_env_light.dungeonlight[5].mColor.b);
}
...
void dKydb_HIO_debug_TVdsp(f32 param_0, f32 param_1, int param_2, int param_3, u16 param_4)
{
    ...
    if (g_kankyoHIO.light.m_displayTVColorSettings == TRUE)
    {
        ...
        {
            dDbVw_Report(sp28,
                         (i * ((sp1C * 4) - sp1C)) + (sp24 + ((sp1C * 4) - sp1C)),
                         "BG%01d   Amb R %03d",
                         i,
                         g_env_light.bg_amb_col[i].r);
            dDbVw_Report(sp28,
                         (i * ((sp1C * 4) - sp1C)) + (sp24 + (sp1C * 4)),
                         "          G %03d",
                         g_env_light.bg_amb_col[i].g);
            dDbVw_Report(sp28,
                         (i * ((sp1C * 4) - sp1C)) + (sp24 + (sp1C * 5)),
                         "          B %03d",
                         g_env_light.bg_amb_col[i].b);
        }
        ...
        for (int i = 0; i < 6; i++)
        {
            if (param_4 & sp30[i + 2])
            {
                dDbVw_Report(sp28 + (sp20 * 20),
                             (i * sp1C) + (sp24 + ((sp1C * 8) - sp1C)),
                             "LIGHT%01d   R %03d G %03d B %03d",
                             i,
    ...
    if (g_kankyoHIO.vrbox.field_0xe >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0xe)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0xe,
                                &g_env_light.vrbox_sky_col.r,
                                &g_env_light.vrbox_sky_col.g,
                                &g_env_light.vrbox_sky_col.b);
        }
    ...
    if (g_kankyoHIO.vrbox.field_0xf >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0xf)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0xf,
    ...
    if (g_kankyoHIO.vrbox.field_0x10 >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0x10)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0x10,
    ...
    if (g_kankyoHIO.vrbox.field_0x11 >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0x11)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0x11,
                                &g_env_light.vrbox_kumo_shadow_col.r,
                                &g_env_light.vrbox_kumo_shadow_col.g,
                                &g_env_light.vrbox_kumo_shadow_col.b);
        }
    ...
    if (g_kankyoHIO.vrbox.field_0x12 >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0x12)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0x12,
    ...
    if (g_kankyoHIO.vrbox.field_0x13 >= 0)
    {
        switch (g_kankyoHIO.vrbox.field_0x13)
        {
            ...
            case 5:
            case 6:
                add_update_proc((u8*)&g_kankyoHIO.vrbox.field_0x13,
...
void dKydb_winddisp_draw()
{
    ...
    if (g_kankyoHIO.wind.display_wind_dir == TRUE)
    {
        ...
        dDbVw_Report(10,
                     410,
                     "WIND x[%f]y[%f]z[%f]pow[%f]",
                     g_env_light.global_wind_influence.vec.x,
                     g_env_light.global_wind_influence.vec.y,
                     g_env_light.global_wind_influence.vec.z,
                     g_env_light.global_wind_influence.pow);
    }
}
...
void dKydb_timedisp()
{
    if (g_kankyoHIO.navy.display_save_location)
    {
        dDbVw_Report(20,
                     16,
                     "ALWAYS SavMem STAGE[%s] Room[%d] Lp[%d]",
    ...
    dDbVw_Report(0x12C,
                 ...
                 dComIfGp_getStartStageDarkArea());
...
void dKydb_efplight_monitor()
{
    ...
    for (i = 0; i < 5; i++)
    {
        if (g_env_light.efplight[i] != NULL)
        {
            OSReport("\n[%d]pos[%f][%f][%f]",
                     i,
                     g_env_light.efplight[i]->mPosition.x,
                     g_env_light.efplight[i]->mPosition.y,
                     g_env_light.efplight[i]->mPosition.z);
        }
    }
}
        ...
        if (g_env_light.pointlight[i] != NULL)
        {
            ...
            if (g_kankyoHIO.point_light_monitor == 2)
            {
                OSReport("pos x[%f]y[%f]z[%f]pow[%f]\n",
                         g_env_light.pointlight[i]->mPosition.x,
                         g_env_light.pointlight[i]->mPosition.y,
                         g_env_light.pointlight[i]->mPosition.z,
                         g_env_light.pointlight[i]->mPow);
            }
        }
    }
}
