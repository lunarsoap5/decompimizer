                             ...
                             bool i_drawBin)
{
    ...
    for (int i = 0; i < 2; i++)
    {
        if ((draw_a && field_0x4be[i] == BUTTON_A_e) || (draw_b && field_0x4be[i] == BUTTON_B_e) ||
            ...
            (draw_3d && field_0x4be[i] == BUTTON_3D_e) || (draw_c && field_0x4be[i] == BUTTON_C_e) ||
            (draw_s && field_0x4be[i] == BUTTON_S_e) || (draw_x && field_0x4be[i] == BUTTON_X_e) ||
            (draw_y && field_0x4be[i] == BUTTON_Y_e) || (draw_nun && field_0x4be[i] == BUTTON_NUN_e) ||
            (draw_remo && field_0x4be[i] == BUTTON_REMO_e) || (draw_remo2 && field_0x4be[i] == BUTTON_REMO2_e) ||
            (draw_ar && field_0x4be[i] == BUTTON_AR_e) || (draw_3db && field_0x4be[i] == BUTTON_3DB_e) ||
            (draw_nure && field_0x4be[i] == BUTTON_NURE_e) || (draw_reel && field_0x4be[i] == BUTTON_REEL_e) ||
            (draw_reel2 && field_0x4be[i] == BUTTON_REEL2_e) || (draw_ab && field_0x4be[i] == BUTTON_AB_e) ||
            (draw_tate && field_0x4be[i] == BUTTON_TATE_e) || (draw_nunZ && field_0x4be[i] == BUTTON_NUNZ_e) ||
            (draw_nunC && field_0x4be[i] == BUTTON_NUNC_e) || (draw_bin && field_0x4be[i] == BUTTON_BIN_e))
        {
    ...
    if (field_0x4d9 != 0xFF &&
        ((draw_a && field_0x4be[field_0x4d9] == BUTTON_A_e) || (draw_b && field_0x4be[field_0x4d9] == BUTTON_B_e) ||
         (draw_r && field_0x4be[field_0x4d9] == BUTTON_R_e) || (draw_z && field_0x4be[field_0x4d9] == BUTTON_Z_e) ||
         (draw_3d && field_0x4be[field_0x4d9] == BUTTON_3D_e) || (draw_c && field_0x4be[field_0x4d9] == BUTTON_C_e) ||
         (draw_s && field_0x4be[field_0x4d9] == BUTTON_S_e) || (draw_x && field_0x4be[field_0x4d9] == BUTTON_X_e) ||
         (draw_y && field_0x4be[field_0x4d9] == BUTTON_Y_e) || (draw_nun && field_0x4be[field_0x4d9] == BUTTON_NUN_e) ||
         (draw_remo && field_0x4be[field_0x4d9] == BUTTON_REMO_e) ||
         (draw_remo2 && field_0x4be[field_0x4d9] == BUTTON_REMO2_e) || (draw_ar && field_0x4be[field_0x4d9] == BUTTON_AR_e) ||
         (draw_3db && field_0x4be[field_0x4d9] == BUTTON_3DB_e) || (draw_nure && field_0x4be[field_0x4d9] == BUTTON_NURE_e) ||
         (draw_reel && field_0x4be[field_0x4d9] == BUTTON_REEL_e) ||
         (draw_reel2 && field_0x4be[field_0x4d9] == BUTTON_REEL2_e) || (draw_ab && field_0x4be[field_0x4d9] == BUTTON_AB_e) ||
         (draw_tate && field_0x4be[field_0x4d9] == BUTTON_TATE_e) || (draw_nunZ && field_0x4be[field_0x4d9] == BUTTON_NUNZ_e) ||
         (draw_nunC && field_0x4be[field_0x4d9] == BUTTON_NUNC_e) || (draw_bin && field_0x4be[field_0x4d9] == BUTTON_BIN_e)))
    {
...
#if VERSION == VERSION_GCN_JPN
        mpString_c->getString(mMsgID, static_cast<J2DTextBox*>(mpTm_c[0]->getPanePtr()), NULL, NULL, NULL, 12);
#else
        mpString_c->getString(mMsgID, static_cast<J2DTextBox*>(mpTm_c[0]->getPanePtr()), NULL, NULL, NULL, 8);
#endif
    ...
    for (int i = 0; i < 2; i++)
    {
        ...
        if (field_0x4be[i] == BUTTON_A_e && dComIfGp_isDoSetFlag(4))
        {
            ...
            mpButtonA->scale(mButtonAScale * temp_f0, mButtonAScale * temp_f0);
                  ...
                  (dComIfGp_getDoStatus() == 0x3B || dComIfGp_getDoStatus() == 0x3F || dComIfGp_getDoStatus() == 0x40) &&
                  dMeter2Info_isBlinkButton(1)) ||
                 (field_0x4be[i] == BUTTON_B_e && dComIfGp_getAStatus() == 0x3A && dMeter2Info_isBlinkButton(2)))
        {
            var_r22 = 1;
        ...
        if (field_0x2e8[i] > 0.0f)
        {
            ...
            else if (field_0x4be[i] != BUTTON_NUN_e && field_0x4be[i] != BUTTON_REMO_e && field_0x4be[i] != BUTTON_REMO2_e &&
                     field_0x4be[i] != BUTTON_AR_e)
            {
                if (field_0x4be[i] == BUTTON_3DB_e)
                {
                    ...
                    var_r3 = 1;
                         ...
                         field_0x4be[i] != BUTTON_REEL2_e && field_0x4be[i] != BUTTON_AB_e && field_0x4be[i] != BUTTON_TATE_e &&
                         field_0x4be[i] != BUTTON_NUNZ_e && field_0x4be[i] != BUTTON_NUNC_e && field_0x4be[i] == BUTTON_BIN_e)
                {
            ...
            if (var_r3)
            {
                if (var_r22)
                {
                    ...
                    {
                        dMeter2Info_getMeterClass()->getMeterDrawPtr()->drawPikari(vtx.x,
                                                                                   vtx.y,
                                                                                   &field_0x2e8[i],
                                                                                   1.8f,
                                                                                   ...
                                                                                   g_drawHIO.mEmpButton.mPikariListenAnimSpeed,
                                                                                   3);
                    }
                    else
                    {
                ...
                else if (var_r23)
                {
                    dMeter2Info_getMeterClass()->getMeterDrawPtr()->drawPikari(vtx.x,
                                                                               ...
                                                                               g_drawHIO.mEmpButton.mPikariRepeatHitAnimSpeed,
                                                                               0);
                }
                else if (isFastSet(i))
                {
                    dMeter2Info_getMeterClass()->getMeterDrawPtr()->drawPikari(vtx.x,
                                                                               vtx.y,
                                                                               &field_0x2e8[i],
                                                                               g_drawHIO.mEmpButton.mPikariFastScale,
                                                                               ...
                                                                               g_drawHIO.mEmpButton.mPikariFastAnimSpeed,
                                                                               0);
                }
                else
                {
                    dMeter2Info_getMeterClass()->getMeterDrawPtr()->drawPikari(vtx.x,
                                                                               vtx.y,
                                                                               &field_0x2e8[i],
                                                                               g_drawHIO.mEmpButton.mPikariScale,
                                                                               ...
                                                                               g_drawHIO.mEmpButton.mPikariAnimSpeed,
                                                                               0);
                }
            }
        }
...
int dMeterButton_c::_delete()
{
    ...
    if ((!dMsgObject_isFukidashiCheck() && !dMsgObject_getMsgObjectClass()->isMidonaTalkWait()) ||
        dMsgObject_getMsgObjectClass()->isPlaceMessage() || dMsgObject_getMsgObjectClass()->isHowlMessage() ||
        dMsgObject_getMsgObjectClass()->isBossMessage() || dMsgObject_getMsgObjectClass()->isBookMessage() ||
        dMsgObject_getMsgObjectClass()->isStaffMessage() || dMsgObject_getMsgObjectClass()->isKanbanMessage() ||
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_A_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || (i_flags & 8) || (i_flags & 0x10) ||
        (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_B_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(4)) ||
        (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_R_e] > 0 ||
#if DEBUG
        (i_flags & 0x80) ||
#endif
        (i_flags & 0x40000000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(8)) || (i_flags & 0x100) || (i_flags & 8) ||
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_Z_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(8)) ||
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_3D_e] > 0 || (i_flags & 8) ||
        (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_C_e] > 0 || (i_flags & 8) ||
        (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_X_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) ||
        (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_Y_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) ||
        (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_NUN_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) ||
        (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_REMO_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) ||
        (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || mButtonTimers[BUTTON_REMO2_e] > 0 ||
        (i_flags & 0x80) || (i_flags & 0x40000000) || (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) ||
        (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) || (i_flags & 0x20))
    {
...
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton || (i_flags & 0x80) || (i_flags & 0x40000000) ||
        (i_flags & 0x1000) || ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) || (i_flags & 0x100) || (i_flags & 8) ||
        (i_flags & 0x10) || (i_flags & 0x20))
    {
...
bool dMeterButton_c::alphaAnimeButtonNunZ(u32 i_flags, bool i_drawButton)
{
    if ((i_flags & 0x4000) || dMsgObject_isTalkNowCheck() || !i_drawButton ||
        ((i_flags & 0x40) && dComIfGp_event_checkHind(1)) || (i_flags & 0x100) || (i_flags & 8) || (i_flags & 0x10) ||
        (i_flags & 0x20))
    {
...
void dMeterButton_c::screenInitButton()
{
    ...
    bool fg = mpButtonScreen->setPriority("zelda_game_image_button_info.blo", 0x20000, dComIfGp_getMeterButtonArchive());
...
#if DEBUG
    if (mpButtonScreen->search('zbtn') == 0)
        OS_REPORT("[%s] %d\n", __FILE__, 1947);
    if (mpButtonScreen->search(MULTI_CHAR('z_btnl')) == 0)
        OS_REPORT("[%s] %d\n", __FILE__, 1948);
#endif
    ...
    dMeter2Info_readItemTexture(fishing_item,
                                mpFishingTex,
                                static_cast<J2DPicture*>(mpItem_c->getPanePtr()),
                                NULL,
                                NULL,
                                NULL,
                                NULL,
...
void dMeterButton_c::screenInitText()
{
    ...
    mpScreen->search(MULTI_CHAR('mg_null'))
        ->move(g_MsgObject_HIO_c.mTextPosX + mpScreen->search(MULTI_CHAR('mg_null'))->getBounds().i.x,
    ...
    fg = mpTextScreen->setPriority("zelda_message_window_text.blo", 0x20000, dComIfGp_getMsgCommonArchive());
    OS_REPORT("[%s] %d\n", __FILE__, 2491);
...
void dMeterButton_c::updateButton()
{
    ...
    if (mParentPosX != g_drawHIO.mEmpButton.mEmpButtonPosX || mParentPosY != g_drawHIO.mEmpButton.mEmpButtonPosY)
    {
...
#if !DEBUG
    else if (strcmp(dComIfGp_getStartStageName(), "R_SP161") == 0 && dComIfGs_isOneZoneSwitch(14, -1))
    {
        parent_y_offset = -25.0f;
        set_parent_offset = true;
    }
    ...
    {
        paneTrans(mpParent, parent_x_offset + (mParentPosX + mParentCenterX), mParentPosY + parent_y_offset, 0xFF);
    }
    ...
    if (mButtonAPosX != g_drawHIO.mEmpButton.mButtonAPosX || mButtonAPosY != g_drawHIO.mEmpButton.mButtonAPosY)
    {
    ...
    if (mButtonBPosX != g_drawHIO.mEmpButton.mButtonBPosX || mButtonBPosY != g_drawHIO.mEmpButton.mButtonBPosY)
    {
    ...
    if (mButtonRPosX != g_drawHIO.mEmpButton.mRButtonPosX || mButtonRPosY != g_drawHIO.mEmpButton.mRButtonPosY)
    {
    ...
    if (mButtonZPosX != g_drawHIO.mEmpButton.mButtonZPosX || mButtonZPosY != g_drawHIO.mEmpButton.mButtonZPosY)
    {
    ...
    if (mButton3DPosX != g_drawHIO.mEmpButton.m3DButtonPosX || mButton3DPosY != g_drawHIO.mEmpButton.m3DButtonPosY)
    {
        mButton3DPosX = g_drawHIO.mEmpButton.m3DButtonPosX;
        mButton3DPosY = g_drawHIO.mEmpButton.m3DButtonPosY;
        paneTrans(mpButton3D, field_0x304[4] + (mButton3DPosX + field_0x18c[4]), mButton3DPosY, 0xFF);
    }
    ...
    if (mButtonCPosX != g_drawHIO.mEmpButton.mCButtonPosX || mButtonCPosY != g_drawHIO.mEmpButton.mCButtonPosY)
    {
    ...
    if (mButtonSPosX != g_drawHIO.mEmpButton.mSButtonPosX || mButtonSPosY != g_drawHIO.mEmpButton.mSButtonPosY)
    {
    ...
    if (mButtonXPosX != g_drawHIO.mEmpButton.mButtonXPosX || mButtonXPosY != g_drawHIO.mEmpButton.mButtonXPosY)
    {
    ...
    if (mButtonYPosX != g_drawHIO.mEmpButton.mButtonYPosX || mButtonYPosY != g_drawHIO.mEmpButton.mButtonYPosY)
    {
    ...
    if (mButton3DBPosX != g_drawHIO.mEmpButton.m3DBButtonPosX || mButton3DBPosY != g_drawHIO.mEmpButton.m3DBButtonPosY)
    {
        mButton3DBPosX = g_drawHIO.mEmpButton.m3DBButtonPosX;
        mButton3DBPosY = g_drawHIO.mEmpButton.m3DBButtonPosY;
        paneTrans(mpButton3DB, field_0x304[13] + (mButtonXPosX + field_0x18c[13]), mButton3DBPosY, 0xFF);
    }
    ...
    if (mButtonBinPosX != g_drawHIO.mEmpButton.mBottleIconPosX || mButtonBinPosY != g_drawHIO.mEmpButton.mBottleIconPosY)
    {
        mButtonBinPosX = g_drawHIO.mEmpButton.mBottleIconPosX;
        mButtonBinPosY = g_drawHIO.mEmpButton.mBottleIconPosY;
        paneTrans(mpButtonBin, field_0x304[21] + (mButtonXPosX + field_0x18c[21]), mButtonBinPosY, 0xFF);
    }

    if (field_0x080 != NULL)
    {
        if (field_0x5f4 != g_drawHIO.mEmpButton.mViewChangePosX || field_0x5f8 != g_drawHIO.mEmpButton.mViewChangePosY)
        {
    ...
    if (mTextPosX[0] != g_drawHIO.mEmpButton.mText1PosX || mTextPosY[0] != g_drawHIO.mEmpButton.mText1PosY)
    {
    ...
    if (mTextPosX[1] != g_drawHIO.mEmpButton.mText2PosX || mTextPosY[1] != g_drawHIO.mEmpButton.mText2PosY)
    {
    ...
    if (var_r4 >= 0)
    {
        if (mItemPosX != g_drawHIO.mEmpButton.mItemPosX || mItemPosY != g_drawHIO.mEmpButton.mItemPosY)
        {
    ...
    if (dMeter2Info_getFloatingMessageTimer() > 0)
    {
        if (mMsgID != dMeter2Info_getFloatingMessageID())
        {
            ...
            bool getString = dMsgObject_getString(dMeter2Info_getFloatingMessageID(),
                                                  static_cast<J2DTextBox*>(mpTm_c[0]->getPanePtr()),
                                                  tbox,
                                                  mDoExt_getMesgFont(),
                                                  mpOutFont,
                                                  buf1,
            ...
            if (getString)
            {
                ...
                for (int i = 0; i < 2; i++)
                {
                    if (field_0x0ec[i] != NULL)
                    {
                        strcpy(static_cast<J2DTextBox*>(field_0x0ec[i]->getPanePtr())->getStringPtr(), buf2);
                    }
                }
            }
        }
        ...
        if (i_flags & 0x4000 || i_flags & 0x40 || i_flags & 0x100 || i_flags & 8 || i_flags & 0x10 || i_flags & 0x20 ||
            timer < 10)
        {
            if (field_0x4b6 > 0)
            {
...
bool dMeterButton_c::isFastSet(int param_0)
{
    if ((dComIfGp_isDoSetFlag(1) && field_0x4be[param_0] == BUTTON_A_e) ||
        ...
        ((dComIfGp_isASetFlag(1) || dComIfGp_isRemoConSetFlag(1)) && field_0x4be[param_0] == BUTTON_AR_e) ||
        ((dComIfGp_isDoSetFlag(1) || dComIfGp_is3DSetFlag(1)) && field_0x4be[param_0] == BUTTON_3DB_e) ||
        ((dComIfGp_isRemoConSetFlag(1) || dComIfGp_isNunSetFlag(1)) && field_0x4be[param_0] == BUTTON_NURE_e) ||
        ((dComIfGp_isRemoConSetFlag(1) || dComIfGp_isNunSetFlag(1)) && field_0x4be[param_0] == BUTTON_REEL_e) ||
        (dComIfGp_isNunSetFlag(1) && field_0x4be[param_0] == BUTTON_REEL2_e) ||
        ((dComIfGp_isDoSetFlag(1) || dComIfGp_isASetFlag(1)) && field_0x4be[param_0] == BUTTON_AB_e) ||
...
{
    if (mpButtonA->getAlphaRate() == 0.0f && mpButtonB->getAlphaRate() == 0.0f && mpButtonR->getAlphaRate() == 0.0f &&
        mpButtonZ->getAlphaRate() == 0.0f && mpButton3D->getAlphaRate() == 0.0f && mpButtonC->getAlphaRate() == 0.0f &&
        mpButtonS->getAlphaRate() == 0.0f && mpButtonX->getAlphaRate() == 0.0f && mpButtonY->getAlphaRate() == 0.0f &&
        mpButton3DB->getAlphaRate() == 0.0f && mpButtonBin->getAlphaRate() == 0.0f && mpText[0]->getAlphaRate() == 0.0f &&
...
f32 dMeterButton_c::getCenterPosCalc(u8 i_button, char* i_string, int param_2)
{
    ...
    f32 rv;
    f32 temp_f0 = 1.0f;
    field_0x1e4[param_2] = (mTextScale[param_2] * dMeter2Info_getStringLength(mpTextBox[0], i_string)) * temp_f0;
    ...
    switch (i_button)
    {
        ...
        case BUTTON_C_e:
            ...
            {
                mButtonWidth[i_button] = mButtonCScale * (mpButtonScreen->search(MULTI_CHAR('yaji_rn'))->getWidth() +
...
void dMeterButton_c::trans_button(int i_idx, f32 param_1)
{
    ...
    if (button != BUTTON_NONE_e)
    {
        ...
        switch (button)
        {
            case BUTTON_A_e:
                paneTrans(mpButtonA,
                          field_0x304[BUTTON_A_e] + (param_1 + (mButtonAPosX + buttonPosOffsetX)),
                          mButtonAPosY,
                          0xFF);
                break;
            case BUTTON_B_e:
                paneTrans(mpButtonB,
                          field_0x304[BUTTON_B_e] + (param_1 + (mButtonBPosX + buttonPosOffsetX)),
                          mButtonBPosY,
                          0xFF);
                break;
            case BUTTON_R_e:
                paneTrans(mpButtonR,
                          field_0x304[BUTTON_R_e] + (param_1 + (mButtonRPosX + buttonPosOffsetX)),
                          mButtonRPosY,
                          0xFF);
                break;
            case BUTTON_Z_e:
                paneTrans(mpButtonZ,
                          field_0x304[BUTTON_Z_e] + (param_1 + (mButtonZPosX + buttonPosOffsetX)),
                          mButtonZPosY,
                          0xFF);
                break;
            case BUTTON_3D_e:
                ...
                paneTrans(mpButton3D,
                          field_0x304[BUTTON_3D_e] + (param_1 + (mButton3DPosX + buttonPosOffsetX)),
                          mButton3DPosY,
                          0xFF);
                break;
            case BUTTON_C_e:
                paneTrans(mpButtonC,
                          field_0x304[BUTTON_C_e] + (param_1 + (mButtonCPosX + buttonPosOffsetX)),
                          mButtonCPosY,
                          0xFF);
                break;
            case BUTTON_S_e:
                paneTrans(mpButtonS,
                          field_0x304[BUTTON_S_e] + (param_1 + (mButtonSPosX + buttonPosOffsetX)),
                          mButtonSPosY,
                          0xFF);
            ...
            case BUTTON_X_e:
                paneTrans(mpButtonX,
                          field_0x304[BUTTON_X_e] + (param_1 + (mButtonXPosX + buttonPosOffsetX)),
                          mButtonXPosY,
                          0xFF);
                break;
            case BUTTON_Y_e:
                paneTrans(mpButtonY,
                          field_0x304[BUTTON_Y_e] + (param_1 + (mButtonYPosX + buttonPosOffsetX)),
                          mButtonYPosY,
                          0xFF);
                break;
            case BUTTON_3DB_e:
        ...
        {
            case 1:
                var_f30 = ((field_0x35c * 0.5f) + (field_0x360 + (screenCenter - field_0x2e0[i_idx]))) -
                          ((mButtonWidth[button] + field_0x29c[i_idx] + fVar4) * 0.5f);
                break;
            case 0:
                var_f30 = mButtonWidth[button] + (((field_0x35c * 0.5f) + (field_0x360 + (screenCenter - field_0x2e0[i_idx]))) -
                                                  ((mButtonWidth[button] + field_0x29c[i_idx] + fVar4) * 0.5f));
                break;
            case 2:
                var_f30 =
                    ((field_0x35c * 0.5f) + (field_0x360 + (screenCenter - field_0x2e0[i_idx]))) - (field_0x29c[i_idx] * 0.5f);
                break;
        }

        paneTrans(mpText[i_idx], param_1 + (mTextPosX[i_idx] + var_f30), (mTextPosY[i_idx] + offsetY) - 2.0f, i_idx);
        ...
        if (field_0x4d7[i] != 0)
        {
                ...
                (isButtonShowBit(BUTTON_BIN_e) && field_0x4be[i] == BUTTON_BIN_e))
            {
                if ((dComIfGp_isDoSetFlag(1) && field_0x4be[i] == BUTTON_A_e) ||
                    ...
                    ((dComIfGp_isASetFlag(1) || dComIfGp_isRemoConSetFlag(1)) && field_0x4be[i] == BUTTON_REMO_e) ||
                    ((dComIfGp_isDoSetFlag(1) || dComIfGp_is3DSetFlag(1)) && field_0x4be[i] == BUTTON_3DB_e) ||
                    ((dComIfGp_isRemoConSetFlag(1) || dComIfGp_isNunSetFlag(1)) && field_0x4be[i] == BUTTON_NURE_e) ||
                    ((dComIfGp_isRemoConSetFlag(1) || dComIfGp_isNunSetFlag(1)) && field_0x4be[i] == BUTTON_REEL_e) ||
                    (dComIfGp_isNunSetFlag(1) && field_0x4be[i] == BUTTON_REEL2_e) ||
                    ((dComIfGp_isDoSetFlag(1) || dComIfGp_isASetFlag(1)) && field_0x4be[i] == BUTTON_AR_e) ||
