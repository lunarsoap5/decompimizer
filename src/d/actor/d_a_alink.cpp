...
static void daAlink_tgHitCallback(fopAc_ac_c* i_tgActor,
...
static void daAlink_coHitCallback(fopAc_ac_c* i_coActorA,
...
daAlink_BckData const daAlink_c::m_mainBckShield[20] = {
    {dRes_ID_ALANM_BCK_ATRFWS_e, dRes_ID_ALANM_BCK_ATRFWS_e}, {dRes_ID_ALANM_BCK_ATRFDS_e, dRes_ID_ALANM_BCK_ATRFDS_e},
    {dRes_ID_ALANM_BCK_ATBW_e, dRes_ID_ALANM_BCK_ATLS_e},     {dRes_ID_ALANM_BCK_ATBD_e, dRes_ID_ALANM_BCK_ATLS_e},
    {dRes_ID_ALANM_BCK_ATRBWS_e, dRes_ID_ALANM_BCK_ATRBWS_e}, {dRes_ID_ALANM_BCK_ATRBDS_e, dRes_ID_ALANM_BCK_ATRBDS_e},
    {dRes_ID_ALANM_BCK_ATSWLS_e, dRes_ID_ALANM_BCK_ATSWLS_e}, {dRes_ID_ALANM_BCK_ATRSWLS_e, dRes_ID_ALANM_BCK_ATRSWLS_e},
    {dRes_ID_ALANM_BCK_ATSWRS_e, dRes_ID_ALANM_BCK_ATSWRS_e}, {dRes_ID_ALANM_BCK_ATRSWRS_e, dRes_ID_ALANM_BCK_ATRSWRS_e},
    {dRes_ID_ALANM_BCK_ATSDLS_e, dRes_ID_ALANM_BCK_ATSDLS_e}, {dRes_ID_ALANM_BCK_ATRSDLS_e, dRes_ID_ALANM_BCK_ATRSDLS_e},
    {dRes_ID_ALANM_BCK_ATSDRS_e, dRes_ID_ALANM_BCK_ATSDRS_e}, {dRes_ID_ALANM_BCK_ATRSDRS_e, dRes_ID_ALANM_BCK_ATRSDRS_e},
    {dRes_ID_ALANM_BCK_WALKH_e, dRes_ID_ALANM_BCK_ATLS_e},    {dRes_ID_ALANM_BCK_ATRBWH_e, dRes_ID_ALANM_BCK_ATLS_e},
    {dRes_ID_ALANM_BCK_ATLS_e, dRes_ID_ALANM_BCK_ATLS_e},     {dRes_ID_ALANM_BCK_ATRS_e, dRes_ID_ALANM_BCK_ATRS_e},
    {dRes_ID_ALANM_BCK_WALKS_e, dRes_ID_ALANM_BCK_ATLS_e},    {dRes_ID_ALANM_BCK_DASHS_e, dRes_ID_ALANM_BCK_ATLS_e},
};
...
daAlink_AnmData const daAlink_c::m_anmDataTable[daAlink_c::ANM_MAX] = {
    ...
    {dRes_ID_ALANM_BCK_ROLLFGOOD_e,
     dRes_ID_ALANM_BCK_ROLLFGOOD_e,
     0x1,
     0x6,
     FTANM_ROLLFGOOD,
     dRes_ID_ALANM_BCK_FROLLFGOOD_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_WAITWATOWB_e,
     dRes_ID_ALANM_BCK_WAITWATOWB_e,
     0x4,
     0x5,
     FTANM_WAITWATOWB,
    ...
    {dRes_ID_ALANM_BCK_CLIMBHANGMISS_e,
     dRes_ID_ALANM_BCK_CLIMBHANGMISS_e,
     0x3,
     0x9,
     FTANM_CLIMBHANGMISS,
     dRes_ID_ALANM_BCK_FCLIMBHANGMISS_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_HEAVYTHROW_e,
     dRes_ID_ALANM_BCK_HEAVYTHROW_e,
     0xFE,
     0xFE,
     FTANM_HEAVYTHROW,
     dRes_ID_ALANM_BCK_FHEAVYTHROW_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_SWIMINGA_e,
     dRes_ID_ALANM_BCK_SWIMINGA_e,
     0xFE,
     0xFE,
     FTANM_SWIMINGA,
     dRes_ID_ALANM_BCK_FSWIMINGA_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_SWIMDIVE_e,
     dRes_ID_ALANM_BCK_SWIMDIVE_e,
     0xFE,
     0xFE,
     FTANM_SWIMDIVE,
     dRes_ID_ALANM_BCK_FSWIMDIVE_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_BOXOPSHORT_e,
     dRes_ID_ALANM_BCK_BOXOPSHORT_e,
     0xFE,
     0xFE,
     FTANM_BOXOPSHORT,
     dRes_ID_ALANM_BCK_FBOXOPSHORT_e,
     0x0},
    {dRes_ID_ALANM_BCK_BOXOPKICK_e,
     dRes_ID_ALANM_BCK_BOXOPKICK_e,
     0xFE,
     0xFE,
     FTANM_BOXOPKICK,
     dRes_ID_ALANM_BCK_FBOXOPKICK_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_CANORELEASE_e,
     dRes_ID_ALANM_BCK_CANORELEASE_e,
     0x2,
     0x5,
     FTANM_CANORELEASE,
    ...
    {dRes_ID_ALANM_BCK_BINSWINGS_e,
     ...
     0x0},
    {dRes_ID_ALANM_BCK_BINSWINGU_e,
     dRes_ID_ALANM_BCK_BINSWINGU_e,
     0x3,
     0xFE,
     FTANM_BINSWINGU,
     dRes_ID_ALANM_BCK_FBINSWINGU_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_GRASSAPLAY_e,
     dRes_ID_ALANM_BCK_GRASSAPLAY_e,
     0x2,
     0xFE,
     FTANM_E_A,
     dRes_ID_ALANM_BCK_FGRASSAPLAY_e,
     0x0},
    {dRes_ID_ALANM_BCK_CATCHTAKA_e,
     dRes_ID_ALANM_BCK_CATCHTAKA_e,
     0x2,
     0xFE,
     FTANM_CATCHTAKA,
     dRes_ID_ALANM_BCK_FCATCHTAKA_e,
     0x0},
    {dRes_ID_ALANM_BCK_WAITTAKA_e,
     dRes_ID_ALANM_BCK_WAITTAKA_e,
     0x2,
     0xFE,
     FTANM_CATCHTAKA,
    ...
    {dRes_ID_ALANM_BCK_SWIMDIEA_e,
     dRes_ID_ALANM_BCK_SWIMDIEA_e,
     0xFE,
     0xFE,
     FTANM_SWIMDIEA,
     dRes_ID_ALANM_BCK_FSWIMDIEA_e,
     0x0},
    {dRes_ID_ALANM_BCK_SWIMDIEP_e,
     dRes_ID_ALANM_BCK_SWIMDIEP_e,
     0xFE,
     0xFE,
     FTANM_SWIMDIEP,
     dRes_ID_ALANM_BCK_FSWIMDIEP_e,
     0x0},
    {dRes_ID_ALANM_BCK_COWAT_e, dRes_ID_ALANM_BCK_COWAT_e, 0x3, 0x9, FTANM_0, dRes_ID_ALANM_BCK_FCOWAT_e, 0x0},
    {dRes_ID_ALANM_BCK_COWCATCHST_e,
     dRes_ID_ALANM_BCK_COWCATCHST_e,
     0x3,
     0x9,
     FTANM_COWCATCHST,
     dRes_ID_ALANM_BCK_FCOWCATCHST_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_COWTHROWL_e,
     dRes_ID_ALANM_BCK_COWTHROWL_e,
     0x3,
     0x9,
     FTANM_COWTHROW_L,
     dRes_ID_ALANM_BCK_FCOWTHROW_e,
     0x0},
    {dRes_ID_ALANM_BCK_COWTHROWR_e,
     dRes_ID_ALANM_BCK_COWTHROWR_e,
     0x3,
     0x9,
     FTANM_COWTHROW_R,
    ...
    {dRes_ID_ALANM_BCK_KEYCATCHH_e,
     dRes_ID_ALANM_BCK_KEYCATCHH_e,
     0x4,
     0x5,
     FTANM_KEYCATCHH,
     dRes_ID_ALANM_BCK_FKEYCATCHH_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_WAITINSECT_e,
     dRes_ID_ALANM_BCK_WAITINSECT_e,
     0x4,
     0xA,
     FTANM_WAITINSECT,
     dRes_ID_ALANM_BCK_FWAITINSECT_e,
     0x0},
    ...
    {dRes_ID_ALANM_BCK_ASHIMOTO_e,
     dRes_ID_ALANM_BCK_ASHIMOTO_e,
     0xFE,
     0xFE,
     FTANM_ASHIMOTO,
     dRes_ID_ALANM_BCK_FASHIMOTO_e,
     0x0},
};
...
static Vec l_jntColPos0[] = {{0.0f, 0.0f, 0.0f}, {44.0f, 0.0f, 0.0f}};

static Vec l_jntColPos1 = {0.0f, -10.0f, 0.0f};

static Vec l_jntColPos2[] = {{-5.0f, 0.0f, 0.0f}, {28.0f, 0.0f, 0.0f}};

static Vec l_jntColPos4[] = {{-4.0f, 0.0f, 0.0f}, {28.0f, 0.0f, 0.0f}};

static Vec l_jntColPos6 = {8.0f, 0.0f, 0.0f};

static Vec l_jntColPos8[] = {{0.0f, 0.0f, 0.0f}, {38.0f, 0.0f, 0.0f}};

static Vec l_jntColPos9[] = {{0.0f, -5.0f, 0.0f}, {35.0f, 0.0f, 0.0f}};

static Vec l_jntColPos10[] = {{0.0f, 5.0f, 0.0f}, {35.0f, 0.0f, 0.0f}};

static Vec l_jntColPos11[] = {{0.0f, 0.0f, 0.0f}, {48.0f, 2.0f, 0.0f}};

static Vec l_jntColPos12[] = {{0.0f, 0.0f, 0.0f}, {48.0f, -2.0f, 0.0f}};

static Vec l_jntColPos13[] = {{0.0f, 5.0f, 0.0f}, {22.0f, 0.0f, 0.0f}};

static Vec l_jntColPos14[] = {{0.0f, -5.0f, 0.0f}, {22.0f, 0.0f, 0.0f}};

static Vec l_jntColPos15[] = {{-15.0f, 0.0f, 17.0f}, {0.0f, 0.0f, 1.0f}};

static Vec l_jntColPos16[] = {{13.0f, 13.0f, -8.0f}, {0.0f, 1.0f, 0.0f}};

static Vec l_jntColPos17 = {-15.0f, -10.0f, -30.0f};
...
static Vec l_wolfJntColPos0[] = {{-25.0f, 20.0f, 0.0f}, {80.0f, 0.0f, 0.0f}};

static Vec l_wolfJntColPos1 = {5.0f, 3.0f, 0.0f};

static Vec l_wolfJntColPos2[] = {{0.0f, 0.0f, 0.0f}, {35.0f, 3.0f, 0.0f}};

static Vec l_wolfJntColPos4[] = {{0.0f, 2.0f, 0.0f}, {30.0f, 0.0f, 0.0f}};

static Vec l_wolfJntColPos6[] = {{0.0f, 0.0f, 0.0f}, {20.0f, 0.0f, 0.0f}};

static Vec l_wolfJntColPos8[] = {{0.0f, -2.0f, 0.0f}, {12.0f, -2.0f, 0.0f}};

static Vec l_wolfJntColPos10[] = {{0.0f, 0.0f, 0.0f}, {33.0f, -2.0f, 0.0f}};

static Vec l_wolfJntColPos12[] = {{-5.0f, -2.0f, 0.0f}, {15.0f, 0.0f, 0.0f}};

static Vec l_wolfJntColPos14[] = {{-4.0f, 0.0f, 0.0f}, {33.0f, 0.0f, 0.0f}};

static Vec l_wolfJntColPos16[] = {{0.0f, -3.0f, 0.0f}, {13.0f, -3.0f, 0.0f}};
...
void daAlink_c::setMatrixWorldAxisRot(MtxP i_mtx, s16 i_rotX, s16 i_rotY, s16 i_rotZ, BOOL param_4, const cXyz* param_5)
{
    cXyz tmp;
...
int daAlink_c::jointControll(int i_jointNo)
{
    ...
    else if ((i_jointNo == 13 || i_jointNo == 12) &&
             (checkCanoeFishingWaitAnime() || checkUnderMove0BckNoArc(ANM_CANOE_FISH_LEFT) ||
              checkUnderMove0BckNoArc(ANM_CANOE_FISH_RIGHT)))
    {
        if (i_jointNo == 13)
        {
            sp18 = field_0x3160;
...
bool daAlink_c::modelCallBack(int i_jointNo)
{
    ...
    if (field_0x2fb6 != 0 &&
        (i_jointNo == 0 || i_jointNo == 5 || i_jointNo == 10 || i_jointNo == 4 || i_jointNo == 13 || i_jointNo == 15))
    {
...
int daAlink_c::headModelCallBack(int i_jointNo)
{
    if (mpDemoHDTmpBck == NULL || !mpDemoHDTmpBck->getBckAnm() || (checkEndResetFlg1(ERFLG1_UNK_400000) && i_jointNo < 6))
    {
        ...
        else
        {
            ...
            setMatrixWorldAxisRot(mpLinkHatModel->getAnmMtx(i_jointNo),
                                  field_0x302c[i_jointNo],
                                  0,
                                  field_0x3040[i_jointNo],
                                  0,
                                  NULL);
...
void daAlink_c::setHatAngle()
{
    if (m_oldFrameCalc->getOldFrameFlg())
    {
        ...
        if (!checkEndResetFlg1(ERFLG1_UNK_80000) &&
            (field_0x35b8.abs2() > SQUARE(10.0f) ||
             (checkEndResetFlg0(ERFLG0_UNK_8) && SQUARE(field_0x3400) + SQUARE(field_0x3404) > SQUARE(10.0f))))
        {
            sp34 = TRUE;
        }
        else
        ...
        *temp_r29 = cLib_minMaxLimit<s16>((*temp_r29 + *sp2C), -0x3800, 0x3800);
        sp10 = cLib_minMaxLimit<s16>(
            cM_atan2s(-((sp9C.x * var_f28) - (sp9C.z * var_f29)), JMAFastSqrt(SQUARE(temp_f27) + SQUARE(sp9C.y))),
            -0x2800,
            0x2800);
...
cXyz* daAlink_c::getNeckAimPos(cXyz* param_0, int* param_1, int param_2)
{
    ...
    if (mProcID == PROC_GOAT_CATCH || mProcID == PROC_GET_ITEM || mProcID == PROC_WOLF_GANON_CATCH ||
        mProcID == PROC_NOT_USE_ITEM || mProcID == PROC_DUNGEON_WARP_READY || mProcID == PROC_GOAT_STROKE)
    {
    ...
    else if (dComIfGp_checkPlayerStatus0(0, 0x10))
    {
        if (mProcID != PROC_NOD && mProcID != PROC_EYE_AWAY && mProcID != PROC_GLARE)
        {
            ...
            if (look_actor != NULL)
            {
                ...
                if (actor_name == fpcNm_MIDNA_e || actor_name == fpcNm_Tag_Wljump_e ||
    ...
    else if (mProcID == PROC_FISHING_CAST || mProcID == PROC_CANOE_FISHING_WAIT || mProcID == PROC_CANOE_FISHING_REEL ||
             mProcID == PROC_CANOE_FISHING_GET)
    {
    ...
    if (!checkEventRun())
    {
        ...
        if ((checkActorPosAngle(field_0x27f0, &sp1C) &&
             (field_0x27f0 == NULL || fopAcM_GetName(field_0x27f0) != fpcNm_Tag_WaraHowl_e)) ||
            checkActorPosAngle(spC, &sp1C) || checkActorPosAngle(field_0x27f8, &sp1C))
        {
            return sp1C;
        }
        ...
        {
            param_0->set(current.pos.x + (200.0f * cM_ssin(current.angle.y)),
                         100.0f + current.pos.y,
                         current.pos.z + (200.0f * cM_scos(current.angle.y)));
            return param_0;
        }
        ...
        if (checkWindSpeedOnAngleAnime(1))
        {
            ...
            {
                param_0->set(current.pos.x - (100.0f * field_0x35b8.x),
                             150.0f + current.pos.y,
                             current.pos.z - (100.0f * field_0x35b8.z));
            }
        ...
        else if (field_0x35c4.abs2XZ() > 1.0f && checkModeFlg(1))
        {
            ...
            param_0->set(current.pos.x + (100.0f * field_0x35c4.x),
                         current.pos.y + var_f31,
                         current.pos.z + (100.0f * field_0x35c4.z));
            return param_0;
        }
        else if (field_0x3594.absXZ() > 1.0f &&
                 (checkUnderMove0BckNoArc(ANM_SWIM_WAIT) || checkUnderMove0BckNoArcWolf(WANM_SWIM_WAIT)))
        {
            param_0->set(current.pos.x + (100.0f * field_0x3594.x),
                         30.0f + current.pos.y,
                         current.pos.z + (100.0f * field_0x3594.z));
            return param_0;
        }
        else if (checkWolf())
        {
                ...
                if (checkAttentionPosAngle(&field_0x37c8))
                {
                    *param_1 = 0;
                    return &field_0x37c8;
                     ...
                     ((checkAttentionState() && mProcID == PROC_WOLF_ATN_AC_MOVE) || mProcID == PROC_WOLF_ROLL_ATTACK_MOVE))
            {
                param_0->set(current.pos.x + (1000.0f * cM_ssin(field_0x2fe4)),
                             eyePos.y,
                             current.pos.z + (1000.0f * cM_scos(field_0x2fe4)));
    ...
    else
    {
        ...
        if (mProcID == PROC_LOOK_WAIT || demoMode == daPy_demo_c::DEMO_UNK_23_e || checkDemoMoveMode(demoMode) ||
            demoMode == daPy_demo_c::DEMO_UNK_1_e || demoMode == daPy_demo_c::DEMO_UNK_4_e ||
            demoMode == daPy_demo_c::DEMO_UNK_44_e || demoMode == daPy_demo_c::DEMO_LOOK_UP_e ||
            demoMode == daPy_demo_c::DEMO_LOOK_UP_TO_GET_ITEM_e || demoMode == daPy_demo_c::DEMO_HAND_PAT_e ||
...
s16 daAlink_c::getNeckAimAngle(cXyz* param_0, s16* param_1, s16* param_2, s16* param_3, s16* param_4)
{
    s16 sp1A;
    s16 sp18;
    s16 sp16 = mPrevAngleY + mBodyAngle.y;
    if ((mProcID == PROC_GOAT_CATCH && mProcVar1.field_0x300a == 0) ||
        (mProcID == PROC_HAND_PAT && mProcVar2.field_0x300c == 0))
    {
    ...
    if (checkModeFlg(0x08000100) && param_0 != NULL && !checkWolfHeadDamageAnime() && !checkDashDamageAnime())
    {
        ...
        if (checkWolf())
        {
            ...
            {
                temp_r24 = cLib_minMaxLimit<s16>((s16)temp_r24,
                                                 mpHIO->mWolf.m.mMaxTiredNeckTurnUp,
                                                 mpHIO->mWolf.m.mMaxTiredNeckTurnDown);
                var_r28 =
                    cLib_minMaxLimit<s16>((s16)var_r28, -mpHIO->mWolf.m.mMaxTiredNeckTurnH, mpHIO->mWolf.m.mMaxTiredNeckTurnH);
            }
            else
            {
...
void daAlink_c::setEyeMove(cXyz* param_0, s16 param_1, s16 param_2)
{
    ...
    else if (!checkEventRun() && checkModeFlg(1) && checkNoResetFlg1(FLG1_UNK_2000) &&
             (checkNoUpperAnime() || checkGrabAnime()) &&
             (mProcID == PROC_WAIT || mProcID == PROC_GRAB_WAIT || mProcID == PROC_CROUCH || mProcID == PROC_HORSE_WAIT ||
...
void daAlink_c::setNeckAngle()
{
    ...
    if (checkUnderMove0BckNoArcWolf(WANM_SMELL) || checkUnderMove0BckNoArc(ANM_HORSE_TURN_B) ||
        checkUnderMove0BckNoArc(ANM_WAIT_INSECT) || checkUnderMove0BckNoArc(ANM_HORSE_TURN_LEFT) ||
...
{
    if ((i_forceCheck || dComIfG_Bgsp().ChkPolySafe(i_polyinf)) && dComIfG_Bgsp().ChkMoveBG_NoDABg(i_polyinf) &&
        dComIfG_Bgsp().GetActorPointer(i_polyinf))
    {
...
void daAlink_c::setMoveSlantAngle()
{
    ...
    if ((mProcID == PROC_MOVE && temp_f31 > mpHIO->mMove.m.mRunChangeRate) ||
        (mProcID == PROC_WOLF_MOVE && temp_f31 > mpHIO->mWolf.mWlMove.m.mIdleToWalkRate))
    {
...
int daAlink_c::setLegAngle(f32 param_0, daAlink_footData_c* param_1, s16* param_2, s16* param_3, int param_4)
{
    cXyz spA4;
    cXyz sp98;
    cXyz sp8C;
...
void daAlink_c::footBgCheck()
{
    ...
    if (m_oldFrameCalc->getOldFrameFlg())
    {
        ...
        BOOL sp1C = !mLinkAcch.ChkGroundHit() || checkMagneBootsOn() || (mLinkAcch.ChkGroundHit() && mSinkShapeOffset < 0.0f) ||
                    checkModeFlg(0x78C52);
        ...
        for (i = 0; i < 2; i++, var_r29++, sp24++)
        {
            ...
            if (-G_CM3D_F_INF != temp_f1 && cBgW_CheckBGround(sp98.mNormal.y) &&
                sp44.y - temp_f1 < l_autoUpHeight - l_autoDownHeight)
            {
                *sp24 = temp_f1;
                var_r29->field_0x0 = 1;
        ...
        else if (sp1C != 0 || sp28 == 0 || mProcID == PROC_TOOL_DEMO || mProcID == PROC_GANON_FINISH ||
                 fabsf(field_0x2b98) > 1.0f)
        {
            var_f31 = 0.0f;
        }
        else
...
int daAlink_c::createHeap()
{
    ...
    if (mpDemoFCBlendModel != NULL)
    {
        ...
        mpDemoFCTmpBls =
            (J3DDeformData*)dComIfG_getObjectRes(dStage_roomControl_c::getDemoArcName(), "demo00_Link_cut00_FC_tmp.bls");
    ...
    // Fairy setup
    {
        ...
        mFairy.mpAnmModel =
            new mDoExt_McaMorfSO(modelData, NULL, NULL, bck, J3DFrameCtrl::EMode_LOOP, 0.4f, 0, -1, NULL, 0x80000, 0x11000084);
...
void daAlink_c::setSelectEquipItem(BOOL param_0)
{
    ...
    if (!checkWolf())
    {
        ...
        if (mClothesChangeWaitTimer == 0 && (prev_model != mSwordModel || checkNoResetFlg2(FLG2_STATUS_WINDOW_DRAW)))
        {
...
int daAlink_c::setStartProcInit()
{
    ...
    else
    {
        ...
        if (mEquipItem == 0 || !checkCastleTownUseItem(mEquipItem) || (checkCloudSea() && mEquipItem != 0x103) ||
            checkCanoeStart() ||
            (isHorseStart && mEquipItem != 0x103 && !checkBowAndSlingItem(mEquipItem) && mEquipItem != dItemNo_BOOMERANG_e &&
             mEquipItem != dItemNo_KANTERA_e && !checkHookshotItem(mEquipItem)))
        {
            mEquipItem = dItemNo_NONE_e;
        }
        else
    ...
    else if (start_mode == 1 || start_mode == 3 || start_mode == 5 || start_mode == 14 || start_mode == 13 || start_mode == 2 ||
             start_mode == 0)
    {
        if (start_mode == 3)
        {
...
int daAlink_c::create()
{
    ...
    BOOL isEnteringLV7 = checkStageName("D_MN07") && dComIfGp_roomControl_getStayNo() == 0 &&
    ...
    if (!bgWaitFlg)
    {
        ...
        if (((!checkBossOctaIealRoom()
            ...
            sceneMode == 9)
        {
            // Override default preference of warp == wolf and spawn player in whatever form they warped with
            if (startPoint == -4)
            {
        ...
        if (checkCanoeStart())
        {
            mRideActorID = fopAcM_create(fpcNm_CANOE_e, 0, &current.pos, fopAcM_GetRoomNo(this), &shape_angle, NULL, -1);
        }
        else if (sceneMode == 11)
        {
            mRideActorID =
                fopAcM_create(fpcNm_Obj_IceLeaf_e, 0x1FFFF, &current.pos, fopAcM_GetRoomNo(this), &shape_angle, NULL, -1);
        }
        else
        {
    ...
    if (mLinkAcch.GetGroundH() == -G_CM3D_F_INF || (startMode == 14 && !dComIfG_Bgsp().ChkMoveBG(mLinkAcch.m_gnd)) ||
    ...
    if (checkStageName("F_SP102") && fopAcM_GetRoomNo(this) == 0 && dComIfG_play_c::getLayerNo(0) == 4)
    {
        onNoResetFlg2(FLG2_BOAR_SINGLE_BATTLE_1ST);
    }
    else if (checkStageName("F_SP123") && fopAcM_GetRoomNo(this) == 13 && dComIfG_play_c::getLayerNo(0) == 0)
    {
    ...
    if ((dComIfGs_getLastSceneMode() & 0x400000) && !checkWolf() && !checkNotHeavyBootsStage() && !isHorseStart &&
        !isEnteringLV7)
    {
        setHeavyBoots(1);
    }
    ...
    {
        setForceGrab((fopAc_ac_c*)fopAcIt_Judge((fopAcIt_JudgeFunc)daAlink_searchLightBall, NULL), 1, 1);
    }
...
void daAlink_c::setShapeAngleOnGround()
{
    ...
    if (checkModeFlg(0x01000000))
    {
        ...
        if (cLib_distanceAngleS(temp_r3, shape_angle.x) < 0x1000 && var_f31 > 0.0f && var_f30 > 0.0f &&
            fabsf(var_f31 - var_f30) > 0.05f)
        {
...
void daAlink_c::setStepsOffset()
{
    ...
    if (!(fabsf(speedF) < 1.0f))
    {
        ...
        cXyz sp14(current.pos.x + (speedF * cM_ssin(current.angle.y)),
                  current.pos.y + l_autoUpHeight,
...
void daAlink_c::setIceSlipSpeed()
{
    ...
    if (!checkModeFlg(0x1210C52) && !checkEventRun() && !checkHeavyStateOn(TRUE, TRUE) &&
        mGndPolySpecialCode == dBgW_SPCODE_ICE && !mLinkAcch.ChkWallHit() && mLinkAcch.ChkGroundHit())
    {
...
void daAlink_c::setPolygonSpeed()
{
    ...
    if ((!checkEventRun() || checkNoResetFlg0(daPy_FLG0(FLG0_DEMO_STREAM_ACCEPT | FLG0_UNK_4000))) && !checkMagneBootsOn())
    {
        ...
        if ((mLinkAcch.ChkGroundHit() && !checkHeavyStateOn(TRUE, TRUE) && mWaterY > 30.0f + current.pos.y) ||
        ...
        else if (mGndPolyAtt1 == 4 && mLinkAcch.ChkGroundHit() && dComIfG_Bgsp().ChkPolySafe(mLinkAcch.m_gnd) &&
                 dComIfG_Bgsp().GetTriPla(mLinkAcch.m_gnd, &tripla) && tripla.mNormal.y <= cM_scos(cM_deg2s(29.9f)))
        {
...
{
    return checkWindSpeedOnAngle() && ((field_0x2f8c == 1 || field_0x2f8c == 3) || (param_0 != 0 && field_0x2f8c == 2));
}
...
f32 daAlink_c::checkWindWallRate(cXyz const& param_0)
{
    ...
    {
        var_f31 = (1.0f / (mpHIO->mBasic.m.mMaxWindInfluenceDist - mpHIO->mBasic.m.mNoWindInfluenceDist)) *
                  (sp24.abs(mLinkLinChk.GetCross()) - mpHIO->mBasic.m.mNoWindInfluenceDist);
        if (var_f31 < 0.0f)
        {
            var_f31 = 0.0f;
        }
...
void daAlink_c::setBodyPartPos()
{
    ...
    else
    {
        ...
        if (dComIfGp_checkPlayerStatus0(0, 0x2000) && !dComIfGp_checkPlayerStatus1(0, 0x02010000) &&
            (!checkModeFlg(0x40000) || !checkNoResetFlg0(FLG0_SWIM_UP)) && !dComIfGp_checkPlayerStatus0(0, 0x08000000))
        {
    ...
    if (checkRootTransClearMode())
    {
        ...
        mViewerCurrentPos.set((current.pos.x - (sp8.z * cM_ssin(shape_angle.y))) - sp8.x * cM_scos(shape_angle.y),
                              current.pos.y - sp8.y,
                              (current.pos.z - (sp8.z * cM_scos(shape_angle.y))) + sp8.x * cM_ssin(shape_angle.y));
    }
}
...
void daAlink_c::setAttentionPos()
{
    ...
    else if (checkModeFlg(0x400))
    {
        ...
        if (mProcID == PROC_CANOE_RIDE || mProcID == PROC_CANOE_GETOFF ||
            (mProcID == PROC_CANOE_WAIT && mProcVar0.field_0x3008 != 0))
        {
            attention_info.position = field_0x34e0;
        }
        ...
        else if (rideActor != NULL)
        {
            if (checkCanoeRide())
            {
                ...
                attention_info.position.set(rideActor->current.pos.x + (var_f31 * cM_ssin(shape_angle.y)),
                                            50.0f + (rideActor->current.pos.y + l_canoeBaseAnime.y),
                                            rideActor->current.pos.z + (var_f31 * cM_scos(shape_angle.y)));
            }
            else
            {
                attention_info.position.set(rideActor->current.pos.x,
                                            275.0f + rideActor->current.pos.y,
                                            rideActor->current.pos.z);
            }
        }
        else
        {
    ...
    {
        attention_info.position.set(current.pos.x + (100.0f * cM_ssin(shape_angle.y)),
                                    -50.0f + current.pos.y,
...
void daAlink_c::setMatrix()
{
    ...
    mDoMtx_stack_c::transS(current.pos.x,
                           field_0x2ba0 + (field_0x2b9c + (var_f30 + (current.pos.y + field_0x2b98))),
                           current.pos.z);
    concatMagneBootMtx();
    ...
    if (!checkWolf())
    {
        if (checkKandelaarEquipAnime() || checkSwordTwirlAnime() || checkNoResetFlg0(FLG0_UNK_1000000) ||
            (checkModeFlg(0x10000) && checkEquipAnime()) || (checkBoardRide() && checkSwordEquipAnime()) ||
        ...
        else if (checkEquipAnime() && !checkModeFlg(1))
        {
            ...
            else
            {
                field_0x2fb6 = 1;
                 ...
                 (checkUnderMove0BckNoArc(ANM_HORSE_TURN_LEFT) || checkUnderMove0BckNoArc(ANM_HORSE_TURN_B) ||
                  checkUnderMove0BckNoArc(ANM_HORSE_TURN_RIGHT)))
        {
            field_0x2fb6 = 6;
        }
        ...
        else if ((mProcID == PROC_SLIDE && field_0x3198 != 0) ||
                 (checkWindDashAnime() && checkUnderMove1BckNoArc(ANM_WALK_HEAVY) && (checkModeFlg(1) || checkZeroSpeedF())))
        {
            field_0x2fb6 = 7;
        }
        else if (checkUpperAnime(dRes_ID_ALANM_BCK_CUTHTP_e) || checkCutDashChargeAnime() ||
                 (checkReinRide() && (checkUpperReadyThrowAnime() || checkGrabAnime())))
        {
            field_0x2fb6 = 3;
        }
...
void daAlink_c::setItemMatrix(int param_0)
{
    ...
    {
        if (param_0 != 0 || (checkPlayerGuardAndAttack() && mEquipItem != dItemNo_IRONBALL_e && !checkModeFlg(0x400)) ||
            checkNoResetFlg0(FLG0_UNK_2) || (mProcID == PROC_TOOL_DEMO && mProcVar4.field_0x3010 != 0) ||
            (mProcID == PROC_CUT_REVERSE && mProcVar2.field_0x300c != 0) || mProcID == PROC_GUARD_BREAK ||
    ...
    if (!checkNoResetFlg2(FLG2_STATUS_WINDOW_DRAW))
    {
        ...
        if (checkNoResetFlg2(FLG2_UNK_1) || checkEndResetFlg1(ERFLG1_UNK_4))
        {
            ...
            if (mProcID != PROC_OPEN_TREASURE && !checkEndResetFlg1(ERFLG1_UNK_4) &&
                (mProcID != PROC_GET_ITEM || mProcVar4.field_0x3010 == 0))
            {
    ...
    if (!checkNoResetFlg2(FLG2_STATUS_WINDOW_DRAW))
    {
        ...
        if (mHeldItemModel != NULL)
        {
            ...
            else
            {
                ...
                {
                    field_0x32d4 = dComIfGp_particle_set(field_0x32d4,
                                                         dPa_RM(ID_ZI_S_ID_SETB_D),
                                                         &mHeldItemRootPos,
                                                         &tevStr,
                                                         NULL,
                                                         NULL,
...
void daAlink_c::setSwordAtCollision(int param_0)
{
    ...
    if (checkCutDashAnime() &&
        (checkCutDashEnemyHit(mAtCps[0]) || checkCutDashEnemyHit(mAtCps[1]) || checkCutDashEnemyHit(mAtCps[2])))
    {
...
BOOL daAlink_c::checkNoCollisionCorret()
{
    if (checkModeFlg(0x12800) || mDemo.getDemoType() == daPy_demo_c::DEMO_TYPE_TOOL_e || mProcID == PROC_DOOR_OPEN ||
        (checkEventRun() && (strcmp(dComIfGp_getEventManager().getRunEventName(), "SCENE_EXIT") == 0 ||
...
void daAlink_c::resetWolfAtCollision()
{
    ...
    {
        if (!setSwordHitVibration(&mAtCyl) && !setSwordHitVibration(&mTgCyls[0]) && !setSwordHitVibration(&mTgCyls[1]))
        {
...
void daAlink_c::setWolfAtCollision()
{
    ...
    if (checkResetFlg0(RFLG0_UNK_2))
    {
        ...
        {
            cXyz sp8(current.pos.x + field_0x3438 * cM_ssin(shape_angle.y),
                     current.pos.y,
...
{
    static const Vec bottleTopPos = {0.0f, 20.0f, 0.0f};

    static Vec rodTopOffset = {0.0f, daCrod_c::getFlyInitY(), 0.0f};
    ...
    {
        if (checkEquipHeavyBoots() && framectrl->getFrame() >= mpHIO->mFrontRoll.m.mBootsAttackInitF &&
            framectrl->getFrame() < mpHIO->mFrontRoll.m.mBootsAttackEndF)
        {
    ...
    {
        if (dComIfGs_getOil() != 0 && mUnderFrameCtrl[0].getFrame() >= field_0x347c &&
            mUnderFrameCtrl[0].getFrame() <= field_0x3480)
        {
            if (mAtSph.ChkAtSet())
            {
    ...
    {
        if (mItemVar0.field_0x3018 == 2 || mItemVar0.field_0x3018 == 3 || mItemVar0.field_0x3018 == 4 ||
            mItemVar0.field_0x3018 == 5 || mItemVar0.field_0x3018 == 7 || mItemVar0.field_0x3018 == 6)
        {
#if DEBUG
    ...
    if (checkResetFlg0(RFLG0_UNK_2))
    {
        if (!setSwordHitVibration(&mAtCps[0]) && !setSwordHitVibration(&mAtCps[1]) && !setSwordHitVibration(&mAtCps[2]) &&
        ...
        if (checkCutDashAnime())
        {
            ...
            spC8.set(current.pos.x + (50.0f * cM_ssin(shape_angle.y)),
                     20.0f + current.pos.y,
            ...
            mProcID == PROC_BOARD_CUT_TURN)
        {
            ...
            if (mProcID == PROC_BOARD_CUT_TURN)
            {
                mProcVar5.field_0x3012 =
                    cM_atan2s(mRightFootPos.x - mLeftFootPos.x, mRightFootPos.z - mLeftFootPos.z) - shape_angle.y;
            }
        }
...
void daAlink_c::setCollision()
{
    ...
    tgCyl = mTgCyls;
    if (checkIronBallWaitAnime() || (checkPlayerGuardAndAttack() && !checkEndResetFlg1(ERFLG1_UNK_20)))
    {
        BOOL isSpShield;
...
void daAlink_c::setFrameCtrl(daPy_frameCtrl_c* i_framectrl, u8 i_attr, s16 i_start, s16 i_end, f32 i_rate, f32 i_frame)
{
...
{
    return mUnderAnmHeap[0].checkNoSetArcNo() && mUnderAnmHeap[0].getIdx() == getMainBckData(i_anmID)->m_underID;
}

BOOL daAlink_c::checkUnderMove1BckNoArc(daAlink_c::daAlink_ANM i_anmID) const
{
    return mUnderAnmHeap[1].checkNoSetArcNo() && mUnderAnmHeap[1].getIdx() == getMainBckData(i_anmID)->m_underID;
}
                                  ...
                                  u32 i_bufSize)
{
    ...
    *i_underBck = (J3DAnmTransform*)getAnimeResource(&mUnderAnmHeap[i_anmPackID], bck_data->m_underID, i_bufSize);
    ...
    if (bck_data->m_underID != bck_data->m_upperID)
    {
        ...
        *i_upperBck = (J3DAnmTransform*)getAnimeResource(&mUpperAnmHeap[i_anmPackID], bck_data->m_upperID, i_bufSize);
        if (*i_upperBck != NULL)
        {
            var_r31 |= 1;
        }
...
void daAlink_c::commonDoubleAnime(J3DAnmTransform* i_underBck1,
                                  J3DAnmTransform* i_upperBck1,
                                  J3DAnmTransform* i_underBck2,
                                  J3DAnmTransform* i_upperBck2,
                                  f32 i_blendRatio,
                                  f32 i_anmSpeed1,
                                  f32 i_anmSpeed2,
                                  int param_7)
{
    ...
    if (i_upperBck1 != NULL)
    {
        ...
        setFrameCtrl(&mUpperFrameCtrl[0],
                     i_upperBck1->getAttribute(),
                     0,
                     temp_f26,
                     temp_f27 * (temp_f30 * temp_f26),
                     var_f31 * temp_f26);
    ...
    if (i_upperBck2 != NULL)
    {
        ...
        setFrameCtrl(&mUpperFrameCtrl[1],
                     i_upperBck2->getAttribute(),
                     0,
                     temp_f25,
                     temp_f27 * (temp_f30 * temp_f25),
                     var_f31 * temp_f25);
                              ...
                              f32 i_morf)
{
    ...
    commonDoubleAnime(under_bck1, upper_bck1, under_bck2, upper_bck2, i_blendRate, i_anmSpeedA, i_anmSpeedB, param_5);
    if (i_morf >= 0.0f)
    {
    ...
    if (checkReinRide())
    {
        if (checkRestHPAnime() && (checkUnderMove0BckNoArc(ANM_HORSE_WAIT) || checkUnderMove0BckNoArc(ANM_HORSE_WALK_A) ||
...
void daAlink_c::commonSingleAnime(J3DAnmTransform* i_underBck,
                                  J3DAnmTransform* i_upperBck,
                                  f32 i_speed,
                                  f32 i_startF,
                                  s16 i_endF)
...
int daAlink_c::setSingleAnime(daAlink_c::daAlink_ANM i_anmID, f32 i_speed, f32 i_start, s16 i_end, f32 i_morf)
{
...
{
    return setSingleAnime(i_anmID,
                          i_anmParams->mSpeed,
                          i_anmParams->mStartFrame,
                          i_anmParams->mEndFrame,
...
int daAlink_c::setUpperAnime(u16 i_anmResIdx,
                             daAlink_c::daAlink_UPPER i_upperIdx,
                             f32 i_speed,
                             f32 i_startFrame,
                             s16 i_endFrame,
                             f32 i_morf)
{
    ...
    {
        resetFacePriAnime();
        offNoResetFlg1(daPy_FLG1(FLG1_UNK_10000000 | FLG1_UNK_4000000 | FLG1_UNK_100000 | FLG1_UNK_40000 | FLG1_UNK_20000 |
                                 FLG1_UNK_10000 | FLG1_UNK_40 | FLG1_UNK_8 | FLG1_UNK_2));
    ...
    if (!checkZoraWearAbility() && (checkEquipAnime() || checkCutDashAnime()) &&
        (checkNoResetFlg0(FLG0_WATER_IN_MOVE) || !checkNoResetFlg0(FLG0_SWIM_UP)))
    {
        i_speed *= mpHIO->mItem.mIronBoots.m.mWaterWalkAnmRate * (1.0f / mpHIO->mItem.mIronBoots.m.mWaterStartWalkAnmRate);
    }
...
void daAlink_c::setUpperAnimeParam(u16 i_anmResIdx, daAlink_c::daAlink_UPPER i_upperIdx, const daAlinkHIO_anm_c* i_anmParam)
{
    setUpperAnime(i_anmResIdx,
                  i_upperIdx,
                  i_anmParam->mSpeed,
                  i_anmParam->mStartFrame,
                  i_anmParam->mEndFrame,
                  i_anmParam->mInterpolation);
}
...
void daAlink_c::setUnderAnimeMorf(f32 i_morf)
{
    if (i_morf >= 0.0f)
    {
        if (m_oldFrameCalc->getOldFrameRate() > 0.1f &&
            (m_oldFrameCalc->getOldFrameStartJoint() == 0 || m_oldFrameCalc->getOldFrameStartJoint() == 1))
        {
            m_oldFrameCalc->initOldFrameMorf(i_morf, 0, 35);
        }
        else
...
int daAlink_c::setUnderAnime(u16 i_resIdx,
                             daAlink_c::daAlink_UNDER i_underIdx,
                             f32 i_speed,
                             f32 i_startF,
                             s16 i_endF,
                             f32 i_morf)
...
int daAlink_c::setUnderAnimeParam(u16 i_resIdx, daAlink_c::daAlink_UNDER i_underIdx, const daAlinkHIO_anm_c* i_anmParam)
{
    return setUnderAnime(i_resIdx,
                         i_underIdx,
                         i_anmParam->mSpeed,
                         i_anmParam->mStartFrame,
                         i_anmParam->mEndFrame,
...
{
    return checkUnderMove0BckNoArc(ANM_ATN_WAIT_LEFT) || checkUnderMove0BckNoArc(ANM_ATN_WALK_LEFT) ||
           checkUnderMove0BckNoArc(ANM_ATN_RUN_LEFT) || checkUnderMove0BckNoArc(ANM_ATN_LOCK_WALK_LEFT) ||
           checkUnderMove0BckNoArc(ANM_ATN_LOCK_RUN_LEFT);
}

BOOL daAlink_c::checkAtnRightAnime()
{
    return checkUnderMove0BckNoArc(ANM_ATN_WAIT_RIGHT) || checkUnderMove0BckNoArc(ANM_ATN_WALK_RIGHT) ||
           checkUnderMove0BckNoArc(ANM_ATN_RUN_RIGHT) || checkUnderMove0BckNoArc(ANM_ATN_LOCK_WALK_RIGHT) ||
...
void daAlink_c::setBlendMoveAnime(f32 i_morf)
{
    ...
    else if ((!sp24 && ((lockon_actor != NULL && (checkEnemyGroup(lockon_actor) || checkGoatCatchActor(lockon_actor))) ||
                        field_0x311c != 0)) ||
             checkEndResetFlg0(ERFLG0_BOSS_ROOM_WAIT) || checkBootsOrArmorHeavy())
    {
        var_r29 = ANM_WAIT_B;
        field_0x2fb3 = 0x2D;
    }
    else if (!sp24 && (field_0x2fb3 != 0 || checkNoResetFlg3(FLG3_UNK_2000) || field_0x35c4.absXZ() > 1.0f ||
                       (checkUnderMove0BckNoArc(ANM_WAIT_B) && !framectrl0->checkPass(0.0f))))
    {
        var_r29 = ANM_WAIT_B;
    }
    else
    ...
    if (sp20)
    {
        if (checkBootsMoveAnime(0))
        {
            ...
            var_f29 =
                mpHIO->mItem.mIronBoots.m.mWalkAnmSpeedMin + (var_f31 * (sp14 - mpHIO->mItem.mIronBoots.m.mWalkAnmSpeedMin));
            var_f27 = 0.0f;
            var_f26 = 23.0f;
        }
        else
        {
            ...
            var_f29 = mpHIO->mItem.mIronBall.m.mWalkAnmSpeedMin +
                      (var_f31 * (mpHIO->mItem.mIronBall.m.mWalkAnmSpeedMax - mpHIO->mItem.mIronBall.m.mWalkAnmSpeedMin));
            var_f27 = 18.0f;
            var_f26 = 3.0f;
        }
    ...
    else if (checkSlope())
    {
        ...
        sp18 = ANM_WALK_SLOPE;
        var_f29 = mpHIO->mSlide.m.mClimbAnmMinSpeed +
                  (var_f31 * (mpHIO->mSlide.m.mMaxClimbAnmSpeed - mpHIO->mSlide.m.mClimbAnmMinSpeed));
        sp2C = var_f29;
    }
    ...
    if (var_f31 < mpHIO->mMove.m.mWalkChangeRate)
    {
        ...
        if (checkModeFlg(1) || checkZeroSpeedF())
        {
            ...
            if (checkUpperGuardAnime() || (mEquipItem == 0x102 && checkAttentionLock()) || checkFmChainGrabAnime() ||
                checkSmallUpperGuardAnime() || checkCopyRodThrowAnime() || checkBoomerangThrowAnime())
            {
                if ((!checkBoomerangThrowAnime() && !checkCopyRodThrowAnime() &&
                     (mEquipItem != 0x102 || !checkAttentionLock())) &&
                    (field_0x2f98 == 2 || checkAtnLeftAnime()))
                {
            ...
            if (abs(sp8) > 100 && mStickValue < 0.3f && checkInputOnR() && mOldStickValue > 0.05f && mOldStickValue < 0.3f &&
                !checkAttentionLock())
            {
            ...
            else if (checkWindSpeedMoveXZ() && !sp24 &&
                     (var_r29 == ANM_WAIT || var_r29 == ANM_WAIT_TIRED || var_r29 == ANM_WAIT_B))
            {
...
void daAlink_c::setFaceBck(u16 i_resIdx, BOOL i_isPriIdx, u16 i_arcNo)
{
    ...
    {
        fopAc_ac_c* lockon_actor = mAttention->LockonTarget(0);
        if (checkAttentionState() || (checkHorseRide() && checkEnemyGroup(lockon_actor)) ||
            checkEndResetFlg0(ERFLG0_NECK_SEARCH_WIDE))
        {
...
void daAlink_c::setFaceBtp(u16 i_resIdx, BOOL i_isPriIdx, u16 i_arcNo)
{
    ...
    if (btp != NULL)
    {
        ...
        if (i_arcNo == 0xFFFF)
        {
            if (i_resIdx == dRes_ID_ALANM_BTP_FMABA03_e ||
                (i_resIdx == dRes_ID_ALANM_BTP_WL_FMABA01_e && checkUnderMove0BckNoArcWolf(WANM_WAIT_WIND)))
            {
                field_0x3440 = 0.02f;
                onNoResetFlg1(FLG1_UNK_2000);
            }
            else if (i_resIdx == dRes_ID_ALANM_BTP_WL_FMABA01_e || i_resIdx == dRes_ID_ALANM_BTP_WL_FMABA02_e ||
                     i_resIdx == dRes_ID_ALANM_BTP_FMABAGOMA_e || i_resIdx == dRes_ID_ALANM_BTP_FMABA01_e ||
...
void daAlink_c::playFaceTextureAnime()
{
    ...
    else
    {
        ...
        {
            int var_r24 =
                mpFaceBtp->getFrameMax() > mpFaceBtk->getFrameMax() ? mpFaceBtp->getFrameMax() : mpFaceBtk->getFrameMax();
    ...
    if (!checkWolf())
    {
        ...
        else if (mFaceBckHeap.checkNoSetPriIdx())
        {
            ...
            if (mFaceBckHeap.checkNoSetArcNo())
            {
                ...
                else if (resIdx == dRes_ID_ALANM_BCK_FSWIMINGB_e || resIdx == dRes_ID_ALANM_BCK_FD_e ||
...
BOOL daAlink_c::getWallEdgePos(cXyz const& param_0, cM3dGPla* i_planeA, cM3dGPla* i_planeB, cXyz* o_outVec, int unused)
{
    UNUSED(unused);
        ...
        if (!checkMagneBootsOn())
        {
            ...
            for (i = 0; i < 3; i++)
            {
                ...
                if (commonLineCheck(&line_start_pos, &line_end_pos))
                {
                    ...
                    else if (!checkWolf() && !sp5C &&
                             ((i == 0 && mLinkAcch.ChkGroundHit() && !checkModeFlg(0x70C52)) || mProcID == PROC_HOOKSHOT_FLY) &&
                             wall_code == 0)
                    {
                        sp5C = TRUE;
            ...
            else
            {
                ...
                field_0x34ec.set(current.pos.x - (sp40 * linchk_tri.mNormal.x),
                                 current.pos.y,
                                 current.pos.z - (sp40 * linchk_tri.mNormal.z));
            ...
            if (!mLinkAcch.ChkWallHit() && !checkWolf() && (var_r29 != 1 || mProcID != PROC_HANG_READY) &&
                (var_r29 != 3 || checkModeFlg(0x40000) || checkModeFlg(2) || !(sp40 <= 51.0f)) &&
                mProcID != PROC_HOOKSHOT_FLY && !checkModeFlg(0x200000))
            {
                offNoResetFlg3(FLG3_UNK_400000);
                return;
            }
                ...
                else if (!checkWolf())
                {
                    if (var_r29 == 1)
                    {
                        if (checkModeFlg(0x40002))
                        {
                            ...
                            line_start_pos.set(field_0x34ec.x - (15.0f * linchk_tri.mNormal.x),
                                               150.0f + sp34,
                                               field_0x34ec.z - (15.0f * linchk_tri.mNormal.z));
            ...
            line_end_pos.set(line_start_pos.x + (sp64 * (50.0f + var_f31)),
                             line_start_pos.y,
                             line_start_pos.z + (sp60 * (50.0f + var_f31)));
            ...
            line_start_pos.set(field_0x34ec.x - (7.5f * linchk_tri.mNormal.x),
                               body_height + (0.01f + hang_height),
                               field_0x34ec.z - (7.5f * linchk_tri.mNormal.z));
            mLinkGndChk.SetPos(&line_start_pos);
            f32 sp1C = dComIfG_Bgsp().GroundCross(&mLinkGndChk);

            line_start_pos.set(field_0x34ec.x - (1.5f * linchk_tri.mNormal.x),
                               body_height + (0.01f + hang_height),
                               field_0x34ec.z - (1.5f * linchk_tri.mNormal.z));
            mLinkGndChk.SetPos(&line_start_pos);
            sp38 = dComIfG_Bgsp().GroundCross(&mLinkGndChk);
            ...
            {
                f32 sp18 = 36.5f;
                line_start_pos.set(wall_edge_pos.x + (10.0f * linchk_tri.mNormal.x),
                                   wall_edge_pos.y + l_autoUpHeight,
                                   wall_edge_pos.z + (10.0f * linchk_tri.mNormal.z));
                line_end_pos.set(wall_edge_pos.x - (linchk_tri.mNormal.x * sp18),
                                 line_start_pos.y,
                                 wall_edge_pos.z - (linchk_tri.mNormal.z * sp18));
    ...
    if (fopAcM_wt_c::waterCheck(&sp14))
    {
        ...
        if (field_0x2fc5 != 6)
        {
            if (checkModeFlg(0x40))
            {
                ...
                {
                    dComIfGp_particle_setWaterRipple(field_0x31a8,
                                                     *fopAcM_wt_c::getWaterCheck(),
                                                     &sp8,
                                                     0.0f,
                                                     &tevStr,
                                                     NULL,
...
void daAlink_c::setBgCheckParam()
{
    ...
    else
    {
        ...
        else if (checkModeFlg(0x400) && !checkSpinnerRide() && !checkBoardRide() && mProcID != PROC_SPINNER_WAIT &&
...
{
    return mSinkShapeOffset < -30.0f || mGndPolyAtt1 == 3 || (mGndPolyAtt1 == 4 && mSinkShapeOffset < -15.0f);
}

BOOL daAlink_c::checkNotItemSinkLimit()
{
    return mSinkShapeOffset < -34.0f && (mGndPolyAtt1 == 1 || mGndPolyAtt1 == 2 || mGndPolyAtt1 == 3 || mGndPolyAtt1 == 4);
}
...
void daAlink_c::setSandShapeOffset()
{
    ...
    if (mSinkShapeOffset < -15.0f)
    {
        ...
        {
            var_r28 =
                cLib_minMaxLimit<int>((128.0f * ((mSinkShapeOffset - -15.0f) / (field_0x3458 - -15.0f))) - 1.0f, -1, 0x7F);
        }
...
{
    if (!checkMagneBootsOn() && mLinkAcch.ChkGroundHit() && !checkModeFlg(0x40000) && mGndPolySpecialCode != 6 &&
        dComIfG_Bgsp().ChkPolySafe(mLinkAcch.m_gnd))
    {
        ...
        if (dComIfG_Bgsp().GetTriPla(mLinkAcch.m_gnd, o_tripla) &&
            (!checkBootsOrArmorHeavy() ||
             (movebg_actorName != fpcNm_Obj_RotStair_e && movebg_actorName != fpcNm_Obj_Lv3R10Saka_e)) &&
            ((mGroundCode != 8 &&
              (mGndPolySpecialCode == 1 || (o_tripla->mNormal.y < field_0x3470 && mGndPolySpecialCode != 2))) ||
             (mGndPolySpecialCode == 5 && !checkWolf() && (!checkInputOnR() || mProcID == PROC_SLIDE) &&
              (o_tripla->mNormal.y < cM_scos(field_0x3122))) ||
             (!checkEquipHeavyBoots() && !dComIfGp_checkPlayerStatus0(0, 0x100) && checkLv2MiddleBossBgRide(movebg_actorName) &&
...
void daAlink_c::setStickData()
{
    ...
    if (checkEventRun() && mProcID != PROC_GRASS_WHISTLE_WAIT && mProcID != PROC_WOLF_DIG_THROUGH &&
        mProcID != PROC_GOAT_CATCH && mProcID != PROC_WOLF_GANON_CATCH && mProcID != PROC_TOOL_DEMO &&
        (mProcID != PROC_METAMORPHOSE || mFallVoiceInit == 0))
    {
        ...
        else if (demoMode == daPy_demo_c::DEMO_UNK_14_e || demoMode == daPy_demo_c::DEMO_UNK_26_e ||
                 demoMode == daPy_demo_c::DEMO_UNK_65_e)
        {
    ...
    else
    {
        ...
        BOOL usingFishRod = checkFishingRodAndLureItem() && mItemAcKeep.getActor() != NULL &&
        ...
        if (checkMagneBootsOn())
        {
            if (field_0x2fb9 == 1 || (field_0x2fb9 == 0 && field_0x3114 != -0x8000 && field_0x3114 <= 0x6000))
            {
                field_0x2fb9 = 1;
            }
            else
        ...
        if (checkHeavyStateOn(TRUE, TRUE) && (!checkBootsOrArmorHeavy() || !checkNoResetFlg0(FLG0_WATER_IN_MOVE)))
        {
        ...
        else if ((checkWolf() && field_0x2fbc == 11 && checkWaterPolygonUnder()) || mGndPolyAtt0 == 11)
        {
...
BOOL daAlink_c::checkAtnWaitAnime()
{
    if ((mTargetedActor != NULL &&
         (checkEnemyGroup(mTargetedActor) || checkGoatCatchActor(mTargetedActor) ||
          fopAcM_GetName(mTargetedActor) == fpcNm_CROD_e || fopAcM_GetName(mTargetedActor) == fpcNm_BOOMERANG_e)) ||
        (checkGrabAnimeUp() || checkGrabAnimeSide() || mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_23_e ||
         checkGoatStopGame()))
    {
        return true;
    }
...
{
    if (!checkPlayerGuard() && (checkNoUpperAnime() || checkHorseTiredAnime()) && mTargetedActor == NULL &&
...
bool daAlink_c::checkAttentionState()
{
    return (checkAttentionLock() || checkFmChainGrabAnime()) ||
           (mTargetedActor != NULL &&
            (mTargetedActor == mThrowBoomerangAcKeep.getActor() || mTargetedActor == mCopyRodAcKeep.getActor())) ||
           (checkUpperReadyThrowAnime() && mEquipItem != 0x102) || mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_23_e;
}
...
void daAlink_c::setNormalSpeedF(f32 i_speed, f32 i_deceleration)
{
    ...
    if ((checkUpperReadyThrowAnime() && mLinkAcch.ChkGroundHit() && field_0x2f8c == 1) ||
        ((checkRoomOnly() || checkCopyRodControllAnime() || checkGrabSlowMoveActor() ||
          (checkUpperGuardAnime() && field_0x2f8c == 1) || (mGndPolyAtt1 == 4 && mSinkShapeOffset < -15.0f)) &&
         (mProcID == PROC_MOVE || mProcID == PROC_ATN_MOVE || mProcID == PROC_ATN_ACTOR_MOVE || mProcID == PROC_WOLF_MOVE ||
          mProcID == PROC_WOLF_ATN_AC_MOVE || mProcID == PROC_MOVE_TURN)))
    {
    ...
    if ((mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_14_e && mDemo.getParam1() == 0) ||
        mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_65_e || getSlidePolygon(&slide_poly))
    {
        return;
    }

    s16 var_r29 = (current.angle.y + 0x8000) - field_0x30fa;
    if ((mLinkAcch.ChkWallHit() || fabsf(field_0x342c) > 1.0f || fabsf(field_0x3430) > 1.0f ||
         (field_0x30fc != 0 && abs(var_r29) < 0x4000)) &&
        !checkMagneBootsOn() && (!getZoraSwim() || abs(field_0x3080) <= 0x2000))
    {
        ...
        else if (field_0x30fc == 1 && mGrabItemAcKeep.getActor() != NULL && current.pos.abs2(field_0x3540) < 1.0f &&
...
void daAlink_c::setSpeedAndAngleNormal()
{
    ...
    if (checkInputOnR())
    {
        ...
        if (!checkAttentionLock() && cLib_distanceAngleS(mMoveAngle, current.angle.y) > 0x7800 && mProcID != PROC_MOVE_TURN)
        {
            ...
            if (mProcID == PROC_MOVE)
            {
                ...
                if ((speedF / mMaxSpeed) <= mpHIO->mMove.m.mSlideThresholdSpeed)
                {
                    cLib_addCalcAngleS(&current.angle.y,
                                       mMoveAngle,
                                       mpHIO->mMove.m.mTurnAngleRate,
                                       mpHIO->mMove.m.mMaxTurnAngle,
                                       mpHIO->mMove.m.mMinTurnAngle);
                    return;
                }
                var_r24 = true;
            }
    ...
    if (!checkAttentionLock() && mProcID != PROC_MOVE_TURN && checkInputOnR())
    {
        ...
        cLib_addCalcAngleS(&shape_angle.y,
                           mMoveAngle,
                           mpHIO->mMove.m.mTurnAngleRate,
                           mpHIO->mMove.m.mMaxTurnAngle * 2,
                           mpHIO->mMove.m.mMinTurnAngle * 2);
...
{
    return !checkEventRun() && !checkEndResetFlg0(ERFLG0_BOSS_ROOM_WAIT) && checkNoUpperAnime() && !checkWindSpeedOnXZ() &&
           field_0x3124.y == 0 && field_0x3124.z == 0 && field_0x3124.x == 0 && !checkFishingRodAndLureItem() &&
...
BOOL daAlink_c::notTalk()
{
    ...
    if ((mMidnaTalkDelayTimer != 0 || (checkMagneBootsOn() && !cBgW_CheckBGround(mMagneBootsTopVec.y))) ||
        (!checkModeFlg(MODE_SWIMMING | MODE_ROPE_WALK | MODE_VINE_CLIMB | MODE_UNK_800 | MODE_RIDING | MODE_NO_COLLISION |
                       MODE_CLIMB | MODE_JUMP) &&
         !isSafePoly))
    {
        return true;
    }
    ...
    if (!checkFmChainGrabAnime() && dComIfGp_getDoStatus() == BUTTON_STATUS_NONE)
    {
        ...
        else if (checkWolf())
        {
            ...
            else
            {
                ...
                else if (field_0x30d2 == 0 && (mStickValue > getFrontRollRate() || checkAttentionLock()))
                {
            ...
            if (checkNotJumpSinkLimit() &&
                (dComIfGp_getDoStatus() == BUTTON_STATUS_UNK_139 || dComIfGp_getDoStatus() == BUTTON_STATUS_FINISH ||
                 dComIfGp_getDoStatus() == BUTTON_STATUS_HELM_SPLITTER || dComIfGp_getDoStatus() == BUTTON_STATUS_JUMP ||
                 dComIfGp_getDoStatus() == BUTTON_STATUS_DASH || dComIfGp_getDoStatus() == BUTTON_STATUS_UNK_147))
            {
        ...
        else
        {
            ...
            if (checkAttentionLock() || (mTargetedActor != NULL && (mTargetedActor == mThrowBoomerangAcKeep.getActor() ||
                                                                    mTargetedActor == mCopyRodAcKeep.getActor())))
            {
            ...
            else if (((checkNoUpperAnime()) || checkIronBallWaitAnime() || checkCopyRodControllAnime()) &&
            ...
            if ((((checkMagneBootsOn() || checkIronBallWaitAnime() || checkNotJumpSinkLimit()) &&
                  (dComIfGp_getDoStatus() == BUTTON_STATUS_UNK_121 || dComIfGp_getDoStatus() == BUTTON_STATUS_UNK_134 ||
                   dComIfGp_getDoStatus() == BUTTON_STATUS_FINISH || dComIfGp_getDoStatus() == BUTTON_STATUS_HELM_SPLITTER ||
                ...
                (!checkMagneBootsOn() || dComIfGp_getDoStatus() != BUTTON_STATUS_UNK_121 ||
        ...
        else
        {
            ...
            else if (mAttList != NULL)
            {
                ...
                else if (checkWolf())
                {
                    ...
                    else if (mTargetedActor != NULL && fopAcM_GetName(mTargetedActor) == fpcNm_B_MGN_e &&
                             mAttention->getActionBtnB() != NULL && mAttention->getActionBtnB()->mType == fopAc_attn_CARRY_e &&
                             mAttention->getActionBtnB()->getActor() == mTargetedActor)
                    {
                        setDoStatus(BUTTON_STATUS_UNK_145);
                    }
                    else if (mTargetedActor != NULL && fopAcM_GetName(mTargetedActor) == fpcNm_E_YM_e &&
                             mAttention->getActionBtnB() != NULL && mAttention->getActionBtnB()->mType == fopAc_attn_ETC_e &&
                             mAttention->getActionBtnB()->getActor() == mTargetedActor)
                    {
                    ...
                    else if (mAttList->mType == fopAc_attn_ETC_e && mPriActorOwn != NULL)
                    {
                        ...
                        else if (actor_name == fpcNm_TAG_HOWL_e || actor_name == fpcNm_Obj_WindStone_e ||
                                 actor_name == fpcNm_Obj_SmWStone_e || actor_name == fpcNm_Tag_WaraHowl_e)
                        {
                            setDoStatusEmphasys(BUTTON_STATUS_HOWL);
                        }
                    ...
                    else if (mTargetedActor != NULL && mPriActorOwn == mTargetedActor && actor_name == fpcNm_Obj_Wchain_e)
                    {
                ...
                {
                    if ((!checkMagicArmorHeavy() && (actor_name == fpcNm_HORSE_e || actor_name == fpcNm_E_WB_e) &&
                    ...
                    else if (actor_name == fpcNm_Obj_YIblltray_e)
                    {
                        setDoStatusEmphasys(BUTTON_STATUS_UNK_153);
                             ...
                             (actor_name == fpcNm_TAG_KMSG_e && static_cast<daTag_KMsg_c*>(mPriActorOwn)->getType() == 3))
                    {
                ...
                else if (mTargetedActor != NULL && checkGoatCatchActor(mTargetedActor) && mAttention->getActionBtnB() != NULL &&
...
BOOL daAlink_c::checkWaitAction()
{
    if (checkWolf())
    {
        ...
        if (checkNoUpperAnime() && checkRestHPAnime() && shape_angle.y == mPrevAngleY &&
            (!checkAttentionState() || shape_angle.y == field_0x2fe4))
        {
    ...
    if (checkRestHPAnime() && !checkPlayerGuardAndAttack() && shape_angle.y == mPrevAngleY &&
        !checkEndResetFlg0(ERFLG0_UNK_8000000) && !checkUnderMove0BckNoArc(ANM_WAIT_B) &&
...
BOOL daAlink_c::checkLandAction(int param_0)
{
    ...
    BOOL isRollLand = mStickValue > 0.8f && move_direction != DIR_BACKWARD && !checkGrabAnime() && mProcID != PROC_CUT_HEAD &&
                      face_direction == DIR_FORWARD;
    ...
    else if (checkNoLandDamageSlidePolygon() || temp_f31 < mpHIO->mDamage.mDamFall.m.mSmallDmgHeight)
    {
        if (param_0)
        {
        ...
        else if (checkInputOnR() && move_direction == DIR_FORWARD && face_direction == DIR_FORWARD && mNormalSpeed > 5.0f)
        {
            if (mNormalSpeed > mpHIO->mMove.m.mMaxSpeed)
            {
                mNormalSpeed = mpHIO->mMove.m.mMaxSpeed;
...
BOOL daAlink_c::checkAutoJumpAction()
{
    ...
    if (!checkModeFlg(0x70C12) && mProcID != PROC_DOOR_OPEN && mProcID != PROC_WARP && !getSumouMode() &&
        mDemo.getDemoType() != daPy_demo_c::DEMO_TYPE_SPECIAL_e && !checkMagneBootsOn() && !mLinkAcch.ChkGroundHit())
    {
        if (checkNoResetFlg0(FLG0_WATER_IN_MOVE))
        {
            speed.y = 0.0f;
            ...
            if (var_r28)
            {
                ...
                if (dComIfGs_getLife() != 0 || dComIfGs_checkBottle(dItemNo_FAIRY_e))
                {
                    if (!checkGoronSideMove() && (!checkNotAutoJumpStage() || checkWolf()))
                    {
                        ...
                        {
                            if (sp14 >= sp10 && (!checkBootsOrArmorHeavy() || checkIronBallWaitAnime()) &&
                                (mStickValue > 0.85f || (checkIronBallWaitAnime() && mMoveValue > 0.85f) ||
                                 mProcID == PROC_WOLF_GIANT_PUZZLE || checkEndResetFlg0(ERFLG0_FORCE_AUTO_JUMP)) &&
                        ...
                        if (!checkEndResetFlg0(ERFLG0_NOT_HANG) && mMode != 0x2B && var_r29 &&
                            dComIfG_Bgsp().GetWallCode(mLinkLinChk) != 2 && sp28 < -mpHIO->mWallHang.m.hang_foot_pos_height &&
                            current.pos.y - mWaterY > sp18 &&
                            (fabsf(sp44.mNormal.y) <= 0.05f ||
                             (sp44.mNormal.y < 0.05f && var_r27 &&
                              getWallEdgePos(mLinkLinChk.GetCross(), &sp44, &sp58, mLinkLinChk.GetCrossP(), 0))))
                        {
                            current.pos.x = mLinkLinChk.GetCross().x;
                            current.pos.z = mLinkLinChk.GetCross().z;
                            ...
                            if ((checkWolf() && procWolfHangFallStartInit(&sp44)) ||
                                (!checkWolf() && procHangFallStartInit(&sp44)))
                            {
                                return 1;
                            }
                        }
...
bool daAlink_c::checkSwordTwirlAction()
{
    ...
    {
        if (checkEnemyGroup(mTargetedActor) && mEquipItem == 0x103 && field_0x2f98 != 1 && checkNoUpperAnime() &&
            cM_rnd() < 0.012f)
        {
            u16 anm;
            if (field_0x2f98 == 2)
    ...
    if (checkFmChainGrabAnime())
    {
        ...
        else
        {
            ...
            if ((!checkWolf() && (checkUnderMove0BckNoArc(ANM_CHAIN_PULL) || checkUnderMove0BckNoArc(ANM_CHAIN_PULL_END))) ||
                (checkWolf() &&
                 (checkUnderMove0BckNoArcWolf(WANM_CHAIN_PULL) || checkUnderMove0BckNoArcWolf(WANM_CHAIN_PULL_END))))
            {
                mNowAnmPackUpper[2].setRatio(0.0f);
            }
            else
...
int daAlink_c::orderTalk(int i_checkZTalk)
{
    ...
    if ((dComIfGp_getDoStatus() == BUTTON_STATUS_SPEAK || dComIfGp_getDoStatus() == BUTTON_STATUS_LOOK ||
         dComIfGp_getDoStatus() == BUTTON_STATUS_UNK_128 || dComIfGp_getDoStatus() == BUTTON_STATUS_LISTEN ||
         dComIfGp_getDoStatus() == BUTTON_STATUS_DRINK || dComIfGp_getDoStatus() == BUTTON_STATUS_CHECK) &&
        talkTrigger())
    {
...
int daAlink_c::orderZTalk()
{
    if ((!checkReinRide() && !checkModeFlg(0x40000) && !checkMagneBootsOn() &&
        ...
        mThrowBoomerangAcKeep.getActor() != NULL || dComIfGp_checkPlayerStatus0(0, 0x8000000) || mProcID == PROC_CRAWL_END ||
        checkHorseZelda() || checkCloudSea() || checkStageName("D_MN08A") ||
        (checkStageName("D_MN09A") &&
         ((fopAcM_GetRoomNo(this) == 50 && dComIfG_play_c::getLayerNo(0) == 0) || fopAcM_GetRoomNo(this) == 51)) ||
    ...
    if (checkMidnaRide())
    {
        ...
        )
        {
            if (zhint != NULL)
            {
                ...
                {
                    fopAcM_orderOtherEventId(zhint,
                                             ((daTagMhint_c*)zhint)->getEventID(),
                                             ((daTagMhint_c*)zhint)->getToolEventID(),
                                             0xFFFF,
                                             0,
                                             1);
                }
...
int daAlink_c::checkNormalAction()
{
    ...
    if (doTrigger())
    {
        ...
        if (dComIfGp_getDoStatus() == BUTTON_STATUS_GET_ON)
        {
            ...
            if (checkStageName("F_SP103") && fopAcIt_Judge((fopAcIt_JudgeFunc)daAlink_searchKolin, NULL))
            {
                return procWaitInit();
            }
            else
        ...
        if (dComIfGp_getDoStatus() == BUTTON_STATUS_OPEN)
        {
            if (mAttList->mType == fopAc_attn_DOOR_e)
            {
                if (!checkStageName("F_SP103") || !fopAcIt_Judge((fopAcIt_JudgeFunc)daAlink_searchBouDoor, NULL))
                {
...
BOOL daAlink_c::checkItemAction()
{
    ...
    if (checkWolf())
    {
        ...
        {
            if (checkEndResetFlg1(ERFLG1_UNK_100000) && mPriActorOwn != NULL &&
                fopAcM_GetName(mPriActorOwn) == fpcNm_Obj_Digholl_e)
            {
    ...
    else
    {
        if (mEquipItem == 0x103)
        {
            ...
            if ((checkUpperAnime(dRes_ID_ALANM_BCK_CUTDL_e) &&
                 frame_ctrl->getFrame() <= mpHIO->mCut.mCutDashLeft.m.mCutAnm.mCancelFrame) ||
                (checkUpperAnime(dRes_ID_ALANM_BCK_CUTDR_e) &&
                 frame_ctrl->getFrame() <= mpHIO->mCut.mCutDashRight.m.mCutAnm.mCancelFrame) ||
                (checkUpperAnime(dRes_ID_ALANM_BCK_CUTDT_e) &&
                 frame_ctrl->getFrame() <= mpHIO->mCut.mCutDashCharge.m.mCutAnm.mCancelFrame) ||
                checkModeFlg(0x40000))
            {
                return false;
            }
        ...
        if (((dComIfGs_isEventBit(dSv_event_flag_c::F_0338) || checkNoResetFlg3(FLG3_TRANING_SHIELD_ATTACK)) &&
             checkGuardActionChange() && !checkUpperReadyThrowAnime() && !checkModeFlg(0x70C52) && checkShieldGet() &&
             !checkNotBattleStage()) &&
...
{
    if (checkNotJumpSinkLimit() || checkHeavyStateOn(TRUE, TRUE) || !checkInputOnR() || !checkCutBackState())
    {
        return false;
    }
...
{
    return checkNoSetUpperAnime() || checkSwimMoveHandAnime() || checkWindDashAnime() || checkSwordTwirlAnime() ||
...
{
    return checkUpperAnime(dRes_ID_ALANM_BCK_WL_DASHWIND_e) ||
           (checkUpperAnime(dRes_ID_ALANM_BCK_DASHWIND_e) && mProcID != PROC_SLIDE);
}
...
void daAlink_c::swordUnequip()
{
    ...
    setUpperAnime(anm_id,
                  UPPER_2,
                  anm_speed,
                  mpHIO->mCut.m.mUnequipAnm.mStartFrame,
...
{
    if (checkNoResetFlg2(FLG2_UNK_1) && param_0 && !checkCanoeRide() && mEquipItem != dItemNo_KANTERA_e)
    {
        for (u8 i = 0; i < 2; i++)
        {
...
BOOL daAlink_c::checkItemChangeFromButton()
{
        ...
        !checkKandelaarSwingAnime() && !checkKandelaarSwingAnime())
    {
...
#endif
            !checkNotBattleStage() && !checkCanoeRide() && (!checkModeFlg(0x40000) || checkEquipHeavyBoots()) &&
        ...
        else if (checkCanoeRide() && !checkStageName("F_SP103") && !checkCanoeSlider() && !checkFisingRodLure() &&
                 swordTrigger())
        {
            itemEquip(0x105);
        }
        else
        {
            ...
            if (doTrigger() && dComIfGp_getDoStatus() == BUTTON_STATUS_PUT_AWAY)
            {
                ...
                else if (mSwordFlourishTimer != 0 && mEquipItem == 0x103 && !checkWoodSwordEquip() && !checkModeFlg(0x402))
                {
            ...
            else if (mEquipItem == dItemNo_NONE_e && mThrowBoomerangAcKeep.getActor() == NULL && !checkCanoeRide() &&
                     checkNoUpperAnime() && checkNoResetFlg2(FLG2_UNK_1))
            {
                for (i = 0; i < 2; i++)
                {
                    if (dComIfGp_getSelectItem(i) == dItemNo_KANTERA_e)
            ...
            else if (mEquipItem != 0x103 && mEquipItem != dItemNo_NONE_e && mEquipItem != 0x10B && mEquipItem != 0x102 &&
                     (!checkCanoeRide() || !checkFisingRodLure()))
            {
    ...
    else if (!checkModeFlg(0x40000))
    {
        if ((checkWolf() && !checkWolfGrabAnime()) ||
            (!checkWolf() && getCopyRodControllActor() == NULL &&
             (checkEquipAnime() || checkNoResetFlg0(FLG0_UNK_1000000) || checkUpperGuardAnime() || checkIronBallWaitAnime() ||
              checkNoUpperAnime())))
        {
            decideDoStatus();
...
int daAlink_c::checkNextAction(int param_0)
{
    ...
    if (checkEndResetFlg0(ERFLG0_UNK_100000) && mLinkAcch.ChkGroundHit() && !checkModeFlg(MODE_PLAYER_FLY))
    {
    ...
    else
    {
        ...
        {
            if (speedF / mMaxSpeed > mpHIO->mMove.m.mSlideThresholdSpeed && mGndPolySpecialCode != dBgW_SPCODE_ICE &&
...
{
    if (mEquipItem == dItemNo_KANTERA_e && field_0x2fde == 0xFF &&
        (mProcID != PROC_PREACTION_UNEQUIP || mProcVar4.field_0x3010 != 0))
    {
        offKandelaarModel();
    }
    ...
    if (!checkEventRun() && !checkNoResetFlg1(FLG1_UNK_40) && (mEquipItem != 0x103 || !checkNoResetFlg3(FLG3_UNK_8000)) &&
        !checkFishingRodAndLureItem() && (checkAttentionLock() || mEquipItem != 0x103 || var_r30))
    {
...
void daAlink_c::setItemAction()
{
    ...
    {
        if (checkAnmEnd(frame_ctrl) ||
            (checkInputOnR() && frame_ctrl->getFrame() > mpHIO->mItem.mBoomerang.m.mCatchAnm.mCancelFrame))
        {
            resetUpperAnime(UPPER_2, 3.0f);
        }
    ...
    {
        if (checkAnmEnd(frame_ctrl) ||
            (checkInputOnR() && frame_ctrl->getFrame() > mpHIO->mItem.mBoomerang.m.mThrowAnm.mCancelFrame))
        {
            resetUpperAnime(UPPER_2, 3.0f);
        }
    ...
    {
        if (checkAnmEnd(frame_ctrl) ||
            (checkInputOnR() && frame_ctrl->getFrame() > mpHIO->mItem.mLantern.m.mShakeAnm.mCancelFrame))
        {
            resetUpperAnime(UPPER_2, 3.0f);
        }
    }
...
{
    return checkBoomerangAnime() || checkCopyRodAnime() || checkHookshotAnime() || checkIronBallAnime() || checkBowAnime();
}
...
BOOL daAlink_c::checkHeavyStateOn(BOOL param_0, BOOL param_1)
{
    if (!checkEventRun())
    {
        if ((param_1 && mSinkShapeOffset < -30.0f) || (param_0 && checkIronBallWaitAnime()) || checkIronBallAnime() ||
...
{
    if (!checkFmChainGrabAnime() || !checkBossRoom() || fopAcM_GetRoomNo(this) != 50 || !checkEquipHeavyBoots())
    {
...
void daAlink_c::transAnimeProc(cXyz* param_0, f32 param_1, f32 param_2)
{
    ...
    *param_0 = field_0x34d4;
    ...
    else if (field_0x2f99 == 0x40 || field_0x2f99 == 0x90 || field_0x2f99 == 0x80 || field_0x2f99 == 0xA0 ||
             field_0x2f99 == 0x70)
    {
        ...
        {
            sp30.set(field_0x384c->x + (sp60.mTranslate.x - temp_r29->mTranslate.x),
                     field_0x384c->y + (sp60.mTranslate.y - temp_r29->mTranslate.y),
                     field_0x384c->z + (sp60.mTranslate.z - temp_r29->mTranslate.z));
        }
        ...
        {
            sp30.set(sp60.mTranslate.x - temp_r29->mTranslate.x,
                     sp60.mTranslate.y - temp_r29->mTranslate.y,
                     sp60.mTranslate.z - temp_r29->mTranslate.z);
        }
...
void daAlink_c::posMove()
{
    ...
    else if (!mLinkAcch.ChkGroundHit() || checkMagneBootsOn() || (checkModeFlg(MODE_PLAYER_FLY) && !checkBoardRide()) ||
             mGroundCode == 8)
    {
        var_r26 = 0;
    }
    ...
    if (!checkEquipHeavyBoots() && mLinkAcch.ChkGroundHit() && !checkModeFlg(0x40) && !eventRunning)
    {
        if (checkLv2MiddleBossBgRide(getMoveBGActorName(mLinkAcch.m_gnd, FALSE)))
        {
            ...
            if (sp24 >= mpHIO->mSlide.m.mLV2MinibossFloorWeakSlideAngle && sp24 <= mpHIO->mSlide.m.mLV2MinibossFloorSlideAngle)
            {
                f32 sp20 = ((sp24 - mpHIO->mSlide.m.mLV2MinibossFloorWeakSlideAngle) *
                            mpHIO->mSlide.m.mLV2MinibossFloorWeakSlideSpeed) /
                           (mpHIO->mSlide.m.mLV2MinibossFloorSlideAngle - mpHIO->mSlide.m.mLV2MinibossFloorWeakSlideAngle);
    ...
    if (checkModeFlg(MODE_SWIMMING))
    {
        ...
        {
            if (checkZoraWearAbility() && mWaterY > current.pos.y + mpHIO->mSwim.m.mNormalBuoyancyWaterDepth)
            {
    ...
    {
        if (checkHeavyStateOn(TRUE, TRUE) && mProcID != PROC_SPINNER_READY && !checkNoResetFlg0(FLG0_WATER_IN_MOVE))
        {
    ...
    else if (checkOctaIealSpecialCollect())
    {
        ...
        (void)0;
                               ...
                               mProcID == PROC_CLIMB_MOVE_UPDOWN || mProcID == PROC_CLIMB_WAIT || mProcID == PROC_HANG_WAIT))
    {
    ...
    else if (var_r27)
    {
        ...
        if (hangMoveBgCheck(shape_angle.y + 0x4000, &sp9C) || hangMoveBgCheck(shape_angle.y - 0x4000, &sp9C))
        {
...
void daAlink_c::autoGroundHit()
{
    ...
    else if (checkModeFlg(0x40000) && checkNoResetFlg0(FLG0_UNK_80) && current.pos.y > mWaterY &&
             current.pos.y - mWaterY < 1000.0f)
    {
        current.pos.y = mWaterY;
    }
    ...
    {
        if ((current.pos.y - mLinkAcch.GetGroundH() > 1500.0f) ||
            (checkSpinnerRide() && mRideAcKeep.getActor() != NULL && ((daSpinner_c*)mRideAcKeep.getActor())->getJumpFlg()))
        {
...
bool daAlink_c::startPeepChange()
{
    if (!checkNoResetFlg0(FLG0_UNK_4000))
    {
        ...
        dStage_changeScene(mPeepExitID, 0.0f, mode, (int)fopAcM_GetRoomNo(this), shape_angle.y, -1);
        return 1;
    }
...
{
    if (!checkNoResetFlg0(FLG0_UNK_4000) && (i_isEventRun || dComIfGp_event_compulsory(this, NULL, 0xFFFF)))
    {
        if (!checkRestartDead(i_dmgAmount, i_mode == 4))
        {
            ...
            else if (checkBoarSingleBattle() || (start_mode == 2 && !checkFinalBattle() && i_mode == 5))
            {
                i_mode = 8;
            }
...
{
    return !checkBoarSingleBattle() && fopAcIt_Judge((fopAcIt_JudgeFunc)daAlink_searchCoach, NULL);
}
...
void daAlink_c::checkRoofRestart()
{
    ...
    if (mLinkAcch.ChkRoofHit() &&
        ...
        !checkMagneBootsOn() && (mProcID != PROC_CRAWL_START && mProcID != PROC_CRAWL_END && !checkCoachGuardGame()))
    {
...
BOOL daAlink_c::checkRestartRoom()
{
    ...
    else if (mLinkAcch.ChkGroundHit() && mGndPolyAtt1 == 2)
    {
        return procCoLavaReturnInit(TRUE);
              ...
              (checkNoResetFlg0(FLG0_UNK_80) && mWaterY - current.pos.y > mpHIO->mSwim.m.mStartHeight)) &&
             fopAcM_GetRoomNo(this) == 0 && checkStageName("F_SP114"))
    {
        return procCoSwimFreezeReturnInit();
    }
    else if (!checkCargoCarry() &&
             (mGroundCode == 4 || mGroundCode == 10 || (-G_CM3D_F_INF == mLinkAcch.GetGroundH() && !checkModeFlg(0x40000))))
    {
        ...
        if ((mGroundCode != 10 && ((temp_r28 && checkModeFlg(0x40000)) ||
                                   (!temp_r28 && (checkModeFlg(2) || checkNoResetFlg3(FLG3_UNK_80000)) &&
                                    mProcID != PROC_HOOKSHOT_FLY && !checkModeFlg(0x800) && var_f31 > var_f30))) ||
            (mGroundCode == 10 && var_f31 <= 3000.0f) ||
            (checkSpinnerRide() && mRideAcKeep.getActor() != NULL &&
             ((daSpinner_c*)mRideAcKeep.getActor())->checkGroundHit()) ||
            (mLinkAcch.ChkGroundHit() && mProcID != PROC_HOOKSHOT_FLY))
        {
            ...
            if (exitID != 0x3F)
            {
                if (!checkNoResetFlg0(FLG0_UNK_4000) && dComIfGp_event_compulsory(this, NULL, 0xFFFF) &&
                    !checkRestartDead(4, FALSE))
                {
                    mDemo.setOriginalDemoType();
                    if (checkSpinnerRide())
                    {
            ...
            return true;
             ...
             (field_0x2fbc == 6 && checkNoResetFlg0(FLG0_UNK_80) && checkWaterPolygonUnder() &&
              mWaterY > (mpHIO->mBasic.m.mLavaDeathDepth + mLinkAcch.GetGroundH())) ||
             (field_0x2fc5 == 6 && -G_CM3D_F_INF != field_0x33b8 && field_0x33bc < field_0x33b8 && checkModeFlg(0x40) &&
              field_0x33b8 > (field_0x33d8 + mpHIO->mBasic.m.mLavaDeathDepth)))
    {
...
int daAlink_c::checkSceneChange(int i_exitID)
{
    ...
    if (var_r3 ||
        ((i_exitID != 0x3F || mExitID != 0x3F) &&
         (checkModeFlg(0x40000) || checkModeFlg(0x400) || mLinkAcch.ChkGroundHit() || mProcID == PROC_DOOR_OPEN ||
          mProcID == PROC_WARP || mProcID == PROC_WOLF_DIG_THROUGH ||
        ...
        ((mExitID & 0x8000) && checkModeFlg(2)))
    {
            ...
            if (daTagHstop_c::getTop() != NULL)
            {
                ...
                for (; hstop != NULL; hstop = hstop->getNext())
                {
                    if (hstop->getActiveFlg())
                    {
                        ...
                        if (pos.y >= -200.0f && pos.y <= hstop->scale.y + 600.0f && fabsf(pos.x) <= hstop->scale.x &&
                            fabsf(pos.z) <= hstop->scale.z)
                        {
                            return 0;
                        }
                    }
        ...
        if (eventInfo.checkCommandDoor() || mProcID == PROC_WARP || mProcID == PROC_WOLF_DIG ||
            mProcID == PROC_WOLF_DIG_THROUGH || field_0x3106 != 0 || dComIfGp_event_compulsory(this, NULL, -1))
        {
            ...
            else
            {
                if (mExitID != 0x3F)
                {
                    isScnChange = dStage_changeScene(mExitID & 0xFF,
                                                     exit_speed,
                                                     exit_mode,
                ...
                {
                    isScnChange = dStage_changeSceneExitId(mLinkAcch.m_gnd,
                                                           exit_speed,
                                                           exit_mode,
                                                           (int)fopAcM_GetRoomNo(this),
                                                           shape_angle.y);
                    field_0x2f58 = dPath_GetRoomPath(dComIfG_Bgsp().GetRoomPathId(mLinkAcch.m_gnd), fopAcM_GetRoomNo(this));
                }
            }
...
BOOL daAlink_c::setItemActor()
{
    ...
    if (mEquipItem == dItemNo_BOOMERANG_e)
    {
        actor = (fopAc_ac_c*)fopAcM_fastCreate(fpcNm_BOOMERANG_e, 0, &current.pos, -1, NULL, NULL, -1, NULL, NULL);
        if (actor == NULL)
        {
            deleteEquipItem(FALSE, FALSE);
            return 0;
    ...
    if (mEquipItem == dItemNo_COPY_ROD_e)
    {
        actor = (fopAc_ac_c*)fopAcM_fastCreate(fpcNm_CROD_e, 0, &current.pos, -1, NULL, NULL, -1, NULL, NULL);
        if (actor == NULL)
        {
            deleteEquipItem(FALSE, FALSE);
            return 0;
...
{
    return dStage_stagInfo_GetSTType(dComIfGp_getStage()->getStagInfo()) == ST_ROOM || checkLv7DungeonShop();
}

bool daAlink_c::checkLv2DungeonRoomSpecial()
{
    return checkStageName("D_MN04") && (dComIfGp_roomControl_getStayNo() == 14 || dComIfGp_roomControl_getStayNo() == 16 ||
                                        dComIfGp_roomControl_getStayNo() == 17);
}

bool daAlink_c::checkRoomSpecial()
{
    return (checkStageName("D_MN11") && (dComIfGp_roomControl_getStayNo() == 1 || dComIfGp_roomControl_getStayNo() == 2)) ||
...
bool daAlink_c::checkCastleTownUseItem(u16 i_itemNo)
{
    ...
    {
        if (i_itemNo == dItemNo_KANTERA_e || checkTradeItem(i_itemNo) ||
...
int daAlink_c::changeItemTriggerKeepProc(u8 i_selItemIdx, int i_procType)
{
    ...
    else if (i_procType == ITEM_PROC_COMMON_CHANGE_ITEM)
    {
        ...
        if (dComIfGp_checkPlayerStatus0(0, 0x2000) &&
            ((checkBowAndSlingItem(field_0x2fde) || checkHookshotItem(field_0x2fde) || field_0x2fde == dItemNo_COPY_ROD_e) ||
...
int daAlink_c::checkNewItemChange(u8 i_selItemIdx)
{
    ...
    if (checkSpinnerRide() || sel_item == dItemNo_BOMB_BAG_LV1_e ||
        ...
        (checkModeFlg(0x40000) && sel_item == dItemNo_WATER_BOMB_e) || !checkCastleTownUseItem(sel_item) ||
        (checkBoardRide() && sel_item != 0x103) ||
        (checkModeFlg(0x400) &&
         (sel_item == dItemNo_EMPTY_BOTTLE_e || sel_item == dItemNo_POKE_BOMB_e || sel_item == dItemNo_IRONBALL_e ||
          sel_item == dItemNo_COPY_ROD_e || checkFishingRodItem(sel_item))) ||
        ((mGndPolySpecialCode == dBgW_SPCODE_HEAVY_SNOW || mGndPolyAtt1 == 1 || mGndPolyAtt1 == 2 ||
          mWaterY - current.pos.y > (daSpinner_c::getWaterSinkLimit() - 5.0f) ||
          (field_0x2fbc == 6 && mWaterY - current.pos.y >= 0.0f) || mGndPolyAtt1 == 3) &&
         sel_item == dItemNo_SPINNER_e) ||
        (checkBossRoom() && checkDungeonWarpItem(sel_item)) ||
        (sel_item == dItemNo_DUNGEON_EXIT_e &&
         (checkLv7DungeonShop() || (checkStageName("D_MN07") && fopAcM_isSwitch(this, 0x4D) && !fopAcM_isSwitch(this, 0x18)) ||
          (checkStageName("D_MN10") && fopAcM_GetRoomNo(this) == 15))) ||
        (checkMagneBootsOn() && sel_item != 0x103 && !checkDrinkBottleItem(sel_item) && sel_item != dItemNo_HVY_BOOTS_e &&
         !checkBowItem(sel_item)))
    {
        return ITEM_PROC_NONE;
    }
    else if (sel_item == dItemNo_HVY_BOOTS_e || checkDungeonWarpItem(sel_item) || checkTradeItem(sel_item) ||
             (checkBottleItem(sel_item) && sel_item != dItemNo_EMPTY_BOTTLE_e) || sel_item == dItemNo_SPINNER_e ||
             sel_item == dItemNo_POKE_BOMB_e || sel_item == dItemNo_HORSE_FLUTE_e || sel_item == dItemNo_HAWK_EYE_e)
    {
        ...
        else if (sel_item == dItemNo_HVY_BOOTS_e)
        {
            if (!checkBoardRide())
            {
                if ((mLinkAcch.ChkGroundHit() && !checkModeFlg(0x70C52)) ||
                    (checkMagneBootsOn() && cBgW_CheckBGround(mMagneBootsTopVec.y)) || mProcID == PROC_HANG_CLIMB)
                {
        ...
        else if (mLinkAcch.ChkGroundHit())
        {
            if (!checkModeFlg(0x70C52))
            {
                ...
                else if (checkItemSetButton(0x108) != 2 && (sel_item == dItemNo_WORM_e || sel_item == dItemNo_BEE_CHILD_e))
                {
                    ...
                    if (sel_item == dItemNo_BEE_CHILD_e && (itemNo == dItemNo_BEE_ROD_e || itemNo == dItemNo_JEWEL_BEE_ROD_e))
                    {
                        return ITEM_PROC_BOTTLE_DRINK;
                    }
                ...
                else if (sel_item == dItemNo_POKE_BOMB_e && dComIfGp_getSelectItemNum(i_selItemIdx) && field_0x2fcf < 2)
                {
    ...
    else if (sel_item != dItemNo_NONE_e && mEquipItem != sel_item)
    {
        if ((checkBombItem(sel_item) && !dComIfGp_getSelectItemNum(i_selItemIdx)) ||
            ...
            (sel_item == dItemNo_KANTERA_e &&
             (checkNoResetFlg0(FLG0_WATER_IN_MOVE) || checkEndResetFlg1(ERFLG1_UNK_4) || checkModeFlg(0x40000))))
        {
            return ITEM_PROC_NONE;
        }
...
void daAlink_c::deleteEquipItem(BOOL i_isPlaySound, BOOL i_isDeleteKantera)
{
    ...
    if (((mEquipItem == dItemNo_BOOMERANG_e || mEquipItem == 0x102) && checkBoomerangAnime()) ||
        (mEquipItem == dItemNo_COPY_ROD_e && checkCopyRodAnime()) || (checkHookshotItem(mEquipItem) && checkHookshotAnime()) ||
...
void daAlink_c::setLight()
{
    ...
    else
    {
        if (checkNoResetFlg2(FLG2_UNK_1) || checkEndResetFlg1(ERFLG1_UNK_4))
        {
            if (dComIfGs_getOil() != 0 && !checkNoResetFlg2(FLG2_KANDELAAR_LIGHT_OFF) &&
                ((checkNoResetFlg2(FLG2_UNK_1) && !checkFreezeDamage()) || checkEndResetFlg1(ERFLG1_UNK_10)))
            {
                ...
                field_0x31c4 = dComIfGp_particle_set(field_0x31c4,
                                                     effName,
                                                     &mKandelaarFlamePos,
                                                     &tevStr,
                                                     &shape_angle,
    ...
    if (field_0x33fc > 0.0f)
    {
        ...
        dKy_WolfEyeLight_set(&spB8,
                             var_f27 + light_m->mXAngle,
                             var_f26,
                             (light_m->mWidth * field_0x33fc) / light_m->mPower,
                             &sp30,
                             field_0x33fc,
...
void daAlink_c::commonProcInit(daAlink_c::daAlink_PROC i_procID)
{
    ...
    else if (checkModeFlg(0x40840) || mProcID == PROC_BOSS_BODY_HANG || mProcID == PROC_WOLF_CHAIN_WAIT)
    {
        field_0x2f99 = 0x70;
    }
    ...
    if (prev_proc_fishcast && (mItemAcKeep.getActor() == NULL || !mItemAcKeep.getActor()->eventInfo.checkCommandDemoAccrpt()) &&
    ...
    if (((!checkEquipAnime() || !checkModeFlg(4)) && (!checkModeFlg(0x40000) || !checkWolfEnemyThrowAnime()) &&
         !checkModeFlg(0x1000)) ||
    ...
    if (!checkModeFlg(MODE_GRAB_PLACE) && !checkGrabAnime() && !checkWolfGrabAnime() && mGrabItemAcKeep.getActor() != NULL)
    {
        freeGrabItem();
    }
    ...
    if ((dComIfGp_checkPlayerStatus0(0, 8) && !checkModeFlg(MODE_VINE_CLIMB) && mProcID != PROC_HANG_CLIMB) ||
        ((dComIfGp_checkPlayerStatus1(0, 0x2000000) && mProcID != PROC_HOOKSHOT_WALL_SHOOT &&
          mProcID != PROC_HOOKSHOT_WALL_WAIT)))
    {
    ...
    {
        if (mProcID != PROC_CAUGHT && mProcID != PROC_HOOKSHOT_FLY && !checkNoResetFlg0(FLG0_WATER_IN_MOVE))
        {
            swimOutAfter(0);
        }
    }
...
int daAlink_c::procTiredWaitInit()
{
    ...
    if (no_upper_anm && ((tired_anm && mNowAnmPackUnder[0].getRatio() < 0.75f) || checkUnderMove1BckNoArc(ANM_STEP_TURN) ||
                         checkUnderMove1BckNoArc(ANM_SMALL_GUARD)))
    {
        f32 frame;
        if (tired_anm)
        {
...
int daAlink_c::procWaitInit()
{
    ...
    if (!checkEventRun() && mProcID == PROC_SERVICE_WAIT && !checkAnmEnd(mUnderFrameCtrl) && checkNoUpperAnime())
    {
        return 0;
    }
    ...
    if (checkEndResetFlg0(ERFLG0_UNK_8000000) && (checkUnderMove0BckNoArc(ANM_WAIT) || checkUnderMove0BckNoArc(ANM_WAIT_TIRED)))
    {
...
int daAlink_c::procWait()
{
    ...
    if (!checkNextAction(0) && !checkFrontWallTypeAction())
    {
        ...
        if (checkAnmEnd(frameCtrl_p) || checkUpperGuardAnime() || !checkUnderMove0BckNoArc(ANM_WAIT_B_TO_A))
        {
...
int daAlink_c::procMove()
{
    ...
    if (!checkNextAction(0) && !checkFrontWallTypeAction())
    {
        if (mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_2_e && mNormalSpeed > mMaxSpeed * mpHIO->mMove.m.mWalkChangeRate)
        {
        ...
        if (mGroundCode != 8)
        {
            mProcNeckX = cLib_minMaxLimit<s16>((s16)(field_0x2ff0 >> 1),
                                               mpHIO->mBasic.m.mHeadMaxTurnUp,
...
int daAlink_c::procWaitTurnInit()
{
    ...
    setSingleAnimeBaseSpeed(ANM_STEP_TURN, mpHIO->mBasic.m.mRotationASpeed, mpHIO->mBasic.m.mBasicInterpolation);
    if (checkEventRun())
    {
        mNormalSpeed = 0.0f;
    }
...
int daAlink_c::procSlide()
{
    ...
    if (getSlidePolygon(&slide_poly))
    {
        ...
        if (field_0x3198 != 0)
        {
            ...
            if (checkInputOnR())
            {
                mProcVar2.field_0x300c = cLib_minMaxLimit<s16>((s16)(mProcVar2.field_0x300c + sin * 256.0f), -0x1000, 0x1000);
            }
            else
            {
...
int daAlink_c::procFrontRoll()
{
    ...
    else if (mDemo.getDemoMode() != daPy_demo_c::DEMO_FRONT_ROLL_e && speedF >= mpHIO->mFrontRoll.m.mCrashSpeedThreshold &&
               ...
               frameCtrl_p->getFrame() <= mpHIO->mFrontRoll.m.mCrashEndF)))
    {
        ...
        if (checkNoResetFlg0(FLG0_UNK_10) || (mLinkAcch.ChkWallHit() && mAcchCir[0].ChkWallHit() &&
...
int daAlink_c::procFrontRollCrash()
{
    ...
    else if ((mLinkAcch.ChkGroundHit() || checkEndResetFlg2(ERFLG2_UNK_100) || checkMagneBootsOn()) && checkModeFlg(2))
    {
        mNormalSpeed = 0.0f;
...
int daAlink_c::procBackJump()
{
    ...
    else if (mDemo.getDemoMode() != 0x10 && current.pos.y < mLastJumpPos.y - mpHIO->mBackJump.m.mFallHeight)
    {
...
int daAlink_c::procSlip()
{
    ...
    else
    {
        ...
        sp8.set(sp14.x + cM_ssin(current.angle.y) * 50.0f, sp14.y, sp14.z + cM_scos(current.angle.y) * 50.0f);
...
int daAlink_c::procAutoJumpInit(int param_0)
{
    ...
    if (chk_mode_400 || (mDemo.getDemoMode() == daPy_demo_c::DEMO_UNK_24_e && mDemo.getParam0() == 1))
    {
        ...
        setSingleAnimeBaseSpeed(ANM_JUMP_LAND, 0.0f, mpHIO->mAutoJump.m.mJumpFallInterpolation);
        field_0x3198 = 0x33;
        current.angle.y = shape_angle.y + 0x8000;
    }
    else
    ...
    {
        if (grab_actor_name == fpcNm_NI_e && ((ni_class*)mGrabItemAcKeep.getActor())->checkGold() == true)
        {
            mMaxSpeed = 30.0f;
        }
        else
    ...
    {
        if (speedF > mMaxSpeed || param_0 || mpHIO->mAutoJump.m.mAlwaysMaxSpeedJump == true)
        {
            speedF = mMaxSpeed;
        }
...
int daAlink_c::procAutoJump()
{
    ...
    {
        if ((fopAcM_GetName(mGrabItemAcKeep.getActor()) == fpcNm_NI_e &&
    ...
    if (mProcVar2.field_0x300c != 0)
    {
        ...
        else
        {
            ...
            {
                setSpecialGravity(mpHIO->mAutoJump.m.mGravity, mpHIO->mAutoJump.m.mMaxFallSpeed * 0.6666667f, FALSE);
            }
...
int daAlink_c::procRollJumpInit()
{
    ...
    setSingleAnimeBaseSpeed(ANM_ROLL_JUMP, 0.0f, mpHIO->mAutoJump.m.mSpinJumpInterpolation);
    ...
    if (dComIfGs_getLife() != 0)
    {
        if (mProcVar0.field_0x3008 == 1)
        {
            ...
            else
            {
                ...
                if ((field_0x32cc != 0 || ((checkInputOnR() && getDirectionFromShapeAngle() == DIR_FORWARD) || doTrigger())) &&
...
int daAlink_c::procLand()
{
    ...
    else if (frameCtrl->checkPass(4.0f))
    {
        ...
        else if (checkNoResetFlg0(FLG0_WATER_IN_MOVE) || field_0x3478 < mpHIO->mDamage.mDamFall.m.mMinRollHeight)
        {
...
int daAlink_c::procSmallJumpInit(int param_0)
{
    ...
    if (param_0 == 2)
    {
        setSingleAnime(ANM_VJUMP_START,
                       mpHIO->mWallHang.mSmallJump.m.mSmallJumpAnm.mSpeed,
                       6.0f,
...
int daAlink_c::procSmallJump()
{
    ...
    else if (mUnderFrameCtrl[0].checkPass(6.0f))
    {
        ...
        {
            speed.y = JMAFastSqrt(
                2.0f * (-gravity * (mpHIO->mWallHang.mSmallJump.m.mTargetHeightOffset + (field_0x3478 - current.pos.y))));
        }
...
int daAlink_c::procStepMove()
{
    ...
    else if (checkAnmEnd(frameCtrl))
    {
        ...
        current.pos.set(field_0x34ec.x + cM_ssin(shape_angle.y) * 2.0f,
                        field_0x34ec.y,
...
int daAlink_c::procCrouchInit()
{
    ...
    setSingleAnimeBaseSpeed(ANM_CROUCH, mpHIO->mCrouch.m.mCrouchAnmSpeed, mpHIO->mCrouch.m.mCrouchInterpolation);
    current.angle.y = shape_angle.y;
    return 1;
}
...
int daAlink_c::procCoMetamorphoseInit()
{
    ...
    else
    {
        ...
        else
        {
            ...
            cXyz pos(current.pos.x + (cM_ssin(shape_angle.y) * 100.0f),
...
int daAlink_c::procCoMetamorphose()
{
    ...
    if (mProcVar0.field_0x3008 != 0 && mProcVar5.field_0x3012 == 0)
    {
        if (mClothesChangeWaitTimer == 0)
        {
            ...
            if (mDemo.getParam0() == 1 && (mDemo.getDemoMode() == daPy_demo_c::DEMO_METAMORPHOSE_UNK1_e ||
                                           mDemo.getDemoMode() == daPy_demo_c::DEMO_METAMORPHOSE_UNK2_e))
            {
                dComIfGp_evmng_cutEnd(mAlinkStaffId);
            ...
            if (mDemo.getDemoType() == daPy_demo_c::DEMO_TYPE_ORIGINAL_e)
            {
             ...
             ((mDemo.getParam0() == 1) && (mDemo.getDemoMode() == daPy_demo_c::DEMO_METAMORPHOSE_UNK1_e ||
                                           mDemo.getDemoMode() == daPy_demo_c::DEMO_METAMORPHOSE_UNK2_e)) ||
             (mProcVar5.field_0x3012 != 0 && framectrl->getFrame() > field_0x3480 &&
              (checkInputOnR() || doTrigger() || grassCancelTrigger())))
    {
        if (mProcVar5.field_0x3012 != 0)
        {
            deleteEquipItem(FALSE, FALSE);
...
int daAlink_c::procFloorDownReboundInit()
{
    ...
    setSingleAnime(ANM_JUMP_LAND,
                   0.69999999f,
                   mpHIO->mAutoJump.m.mLandAnm.mStartFrame,
                   mpHIO->mAutoJump.m.mLandAnm.mEndFrame,
                   10.0f);
    mNormalSpeed = 0.0f;
    current.angle.y = shape_angle.y;
    field_0x2f98 = 4;
...
int daAlink_c::execute()
{
    ...
    if (checkNoResetFlg2(FLG2_UNK_1) != FALSE && mEquipItem != dItemNo_KANTERA_e && checkItemSetButton(dItemNo_KANTERA_e) == 2)
    {
        offKandelaarModel();
    }
    ...
    if (dComIfGp_event_runCheck())
    {
        ...
        if (eventInfo.checkCommandDoor() && !dComIfGp_event_chkEventFlag(4) && mEquipItem == 0x102)
        {
            deleteEquipItem(FALSE, FALSE);
        }
    }
    ...
    if (checkMagneBootsOn())
    {
            ...
            dComIfG_Bgsp().ChkMoveBG(mMagneLineChk))
        {
            ...
            dComIfG_Bgsp().MoveBgCrrPos(mMagneLineChk, true, &current.pos, &current.angle, &shape_angle, false, false);
    ...
    else if (mProcID != PROC_HOOKSHOT_FLY && !checkModeFlg(MODE_VINE_CLIMB | MODE_UNK_800) && mProcID != PROC_TOOL_DEMO &&
             mLinkAcch.GetGroundH() != -G_CM3D_F_INF && dComIfG_Bgsp().ChkPolySafe(mLinkAcch.m_gnd) &&
             dComIfG_Bgsp().ChkMoveBG(mLinkAcch.m_gnd))
    {
        ...
        dComIfG_Bgsp().MoveBgCrrPos(mLinkAcch.m_gnd, uvar23, &current.pos, &current.angle, &shape_angle, false, false);
    ...
    if (checkWolfEyeUp())
    {
        ...
        if (event_name != NULL && (strcmp(event_name, "kiko_yami") == 0 || strcmp(event_name, "fire_insect") == 0 ||
                                   (checkStageName("F_SP108") &&
                                    (strcmp(event_name, "MapToolCamera19") == 0 || strcmp(event_name, "yami_mog") == 0)) ||
                                   (checkStageName("R_SP109") &&
                                    (strcmp(event_name, "MapToolCamera1") == 0 || strcmp(event_name, "MapToolCamera2") == 0 ||
                                     strcmp(event_name, "MapToolCamera19") == 0 || strcmp(event_name, "fire_insect") == 0)) ||
                                   (checkStageName("F_SP115") && strcmp(event_name, "MapToolCamera23") == 0)))
        {
            mWolfEyeUp = mpHIO->mWolf.m.mSensesLingerTime + 1;
                 ...
                 mProcID == PROC_WOLF_GET_SMELL || mProcID == PROC_WOLF_DIG || mProcID == PROC_WOLF_DIG_THROUGH ||
                 checkNoResetFlg0(FLG0_UNK_4000) || dComIfGp_checkPlayerStatus1(0, 0x1000000) ||
    ...
    if (item_actor != NULL && (!fopAcM_checkCarryNow(item_actor) ||
                               (checkNoResetFlg0(FLG0_WATER_IN_MOVE) &&
                                (checkGrabRooster() || fopAcM_GetName(item_actor) == fpcNm_E_NEST_e || checkGrabCarryActor()))))
    {
        freeGrabItem();
        item_actor = NULL;
    }
...
#endif
    {
        ...
        {
            if (!checkDemoAction() && !checkDeadAction(0) && !checkNoResetFlg0(FLG0_UNK_100000) && !checkAutoJumpAction())
            {
                checkSwimAction(0);
            }
        ...
        else
        {
            ...
            if (checkCutFastReady())
            {
                if (checkNoUpperAnime())
                {
                    setUpperAnime(dRes_ID_ALANM_BCK_WAITATOS_e,
                                  UPPER_2,
                                  mpHIO->mCut.m.mEquipAnm.mSpeed,
                                  12.0f,
...

        {
            ...
            if (checkNoResetFlg0(FLG0_WATER_IN_MOVE) || (checkPossibleWaterInMode() && !checkNoResetFlg0(FLG0_SWIM_UP)))
            {
                f32 var_f31;
                if (mProcID == PROC_HOOKSHOT_FLY)
                {
                ...
                if (!checkNoResetFlg0(FLG0_UNK_80) || mWaterY - var_f31 <= mpHIO->mSwim.m.mStartHeight - 5.0f)
                {
                    swimOutAfter(0);
                }
            }
                ...
                if (field_0x3198 != 0)
                {
                    if (mLinkAcch.GetGroundH() != -G_CM3D_F_INF)
                    {
                     ...
                     (checkModeFlg(MODE_ROPE_WALK | MODE_VINE_CLIMB | MODE_UNK_800 | MODE_RIDING) &&
                      mProcID != PROC_HORSE_GETOFF && mProcID != PROC_WOLF_CHAIN_READY && !checkBoardRide()))
            {
                current.pos = pos;
            }
            ...
            if (mLinkAcch.GetGroundH() != -G_CM3D_F_INF)
            {
                ...
                if (!checkModeFlg(MODE_PLAYER_FLY) && !checkMagneBootsOn() && mProcID != PROC_TOOL_DEMO &&
                    mProcID != PROC_GANON_FINISH && mProcID != PROC_DUNGEON_WARP && (field_0x2f8c == 1 || field_0x2f8c == 3))
                {
                    setStepsOffset();
                }
                else
            ...
            if (checkModeFlg(MODE_VINE_CLIMB) && mProcVar2.field_0x300c != 0 && dComIfG_Bgsp().ChkPolySafe(mPolyInfo1))
            {
            ...
            else
            {
                ...
                if (mClothesChangeWaitTimer == 0)
                {
                    if ((pmidna->checkMidnaTired() || pmidna->checkForceTiredColor()) && !pmidna->checkForceNormalColor())
                    {
            ...
            if (checkAttentionLock() ||
                (!checkUpperReadyThrowAnime() && mProcID != PROC_HOOKSHOT_WALL_SHOOT && mProcID != PROC_HOOKSHOT_ROOF_SHOOT))
            {
                mFastShotTime = 0;
            }
...
#endif
            {
                if (!checkMagneBootsOn())
                {
                    ...
                    {
                        eventInfo.onCondition(dEvtCnd_40_e | dEvtCnd_10_e | dEvtCnd_CANGETITEM_e | dEvtCnd_CANDOOR_e |
                                              dEvtCnd_CANTALK_e);
                    }
            ...
            else
            {
                ...
                {
                    if (checkWolf() || (mPriActorOwn != NULL &&
...
void daAlink_c::setDrawHand()
{
    ...
    else
    {
        ...
        {
            if (mProcID == PROC_BOSS_BODY_HANG || mProcID == PROC_MASTER_SWORD_PULL ||
                (mProcID == PROC_CUT_DOWN_LAND && mProcVar2.field_0x300c != 0))
            {
        ...
        else if (field_0x2f97 != 0xFF &&
                 (!checkNoResetFlg1(FLG1_UNK_100000) || (field_0x2f95 == 0xFF && field_0x2e44.checkPassNum(0xF))))
        {
...
bool daAlink_c::checkItemDraw()
{
    ...
    {
        if (!checkBowAndSlingItem(mEquipItem) || checkBowGrabLeftHand() || !checkShieldGet() || field_0x2e44.checkPassNum(15))
        {
            return true;
        }
    }
...
int daAlink_c::initShadowScaleLight()
{
    ...
    cXyz sp20(tevStr.mLightPosWorld.x - field_0x3834.x,
              tevStr.mLightPosWorld.y - field_0x3454,
              tevStr.mLightPosWorld.z - field_0x3834.z);
    ...
    f32 var_f31;
    if (talkActor != NULL &&
        ((fopAcM_GetName(talkActor) == fpcNm_Tag_Mhint_e && !((daTagMhint_c*)talkActor)->checkNoAttention()) ||
         (fopAcM_GetName(talkActor) == fpcNm_Tag_Mstop_e && !((daTagMstop_c*)talkActor)->checkNoAttention())))
    {
    ...
    else
    {
        ...
        cXyz sp8(sp14.x + ((30.0f + var_f31) * cM_ssin(shape_angle.y)),
                 sp14.y,
                 sp14.z + ((30.0f + var_f31) * cM_scos(shape_angle.y)));
...
int daAlink_c::moveShadowScaleLight()
{
    ...
    tevStr.mLightPosWorld.set(field_0x3834.x + (temp_f31 * cM_ssin(field_0x2ff6)),
                              field_0x3454 + (50000.0f * cM_ssin(field_0x2ff4)),
                              field_0x3834.z + (temp_f31 * cM_scos(field_0x2ff6)));
    return var_r29;
}
...
void daAlink_c::shadowDraw()
{
    ...
    if (midna != NULL && ((midna->checkShadowModelDraw() && (field_0x2ff4 >= 0x3FF0 || !checkMidnaRide())) ||
                          midna->checkShadowModelDrawDemoForce()))
    {
        return;
    }
    ...
    if (!checkBoarRide())
    {
        ...
        else
        {
            ...
            field_0x31a4 = dComIfGd_setShadow(field_0x31a4,
                                              sp8,
                                              mpLinkModel,
                                              &spC,
                                              800.0f,
            ...
            else
            {
                ...
                else if (checkItemDraw())
                {
                    if (mEquipItem == dItemNo_IRONBALL_e)
                    {
                        ...
                        {
                            field_0x32d4 = dComIfGd_setShadow(field_0x32d4,
                                                              0,
                                                              mHeldItemModel,
                                                              &mIronBallCenterPos,
                                                              150.0f,
                                                              32.0f,
                                                              mIronBallBgChkPos.y,
                                                              fopAcM_gc_c::getGroundY(),
                                                              *fopAcM_gc_c::getGroundCheck(),
                                                              &tevStr,
                                                              0,
                                                              1.0f,
                                                              dDlst_shadowControl_c::getSimpleTex());
...
void daAlink_c::setWaterDropColor(const J3DGXColorS10* i_color)
{
    ...
    {
        if (checkNoResetFlg2(FLG2_UNK_80000) || checkZoraWearAbility() || checkMagicArmorWearAbility())
        {
...
int daAlink_c::draw()
{
    ...
    else if (mProcID == PROC_METAMORPHOSE || mProcID == PROC_DUNGEON_WARP || mProcID == PROC_DUNGEON_WARP_SCN_START)
    {
    ...
    else
    {
        ...
        if (checkItemDraw())
        {
            ...
            if (mEquipItem == dItemNo_W_HOOKSHOT_e && !checkPlayerGuardAndAttack() && !checkNoResetFlg0(FLG0_UNK_2))
            {
            ...
            if (mpHookChain != NULL && !isPlayerNoDraw &&
                ((checkHookshotItem(mEquipItem) &&
                  (mHeldItemRootPos.abs(mHookshotTopPos) > 1.0f || field_0x3810.abs(mIronBallBgChkPos) > 1.0f)) ||
...
static actor_method_class l_daAlink_Method = {
    (process_method_func)daAlink_Create,
    (process_method_func)daAlink_Delete,
    (process_method_func)daAlink_Execute,
