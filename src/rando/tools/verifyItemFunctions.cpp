...
uint getProgressiveSword() {
    static const u8 progressiveItemsList[] = {dItemNo_WOOD_STICK_e, dItemNo_SWORD_e,
...
uint getProgressiveSkill() {
    static const u8 progressiveItemsList[] = {dItemNo_ENDING_BLOW_e, dItemNo_SHIELD_ATTACK_e,
                                              dItemNo_BACK_SLICE_e,  dItemNo_HELM_SPLITTER_e,
                                              dItemNo_MORTAL_DRAW_e, dItemNo_JUMP_STRIKE_e};
...
uint getProgressiveMirrorShard() {
    static const u8 progressiveItemsList[] = {dItemNo_MIRROR_PIECE_1_e, dItemNo_MIRROR_PIECE_2_e,
                                              dItemNo_MIRROR_PIECE_3_e};
...
u8 getWarashibeItemCount() {
    static const u8 itemsList[] = {dItemNo_LETTER_e, dItemNo_BILL_e, dItemNo_WOOD_STATUE_e,
                                   dItemNo_IRIAS_PENDANT_e, dItemNo_HORSE_FLUTE_e};
    u8 count = 0;
