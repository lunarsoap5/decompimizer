...
public:
    ...
    static ResourceData mData[33];
    static f32 const m_cullfar_max;

    enum {
        SHOP_ITEMNO_SOLD,
        SHOP_ITEMNO_ARMOR_SOLD,
        SHOP_ITEM_SERA_LARVA,
        SHOP_ITEM_SERA_MILK,
        SHOP_ITEM_SERA_OIL,
        SHOP_ITEM_SERA_SLINGSHOT,
        SHOP_ITEM_KAK_MALO_ARROWS,
        SHOP_ITEM_KAK_MALO_HAWKEYE,
        SHOP_ITEM_KAK_MALO_WOOD_SHIELD,
        SHOP_ITEM_KAK_MALO_HYLIA_SHIELD,
        SHOP_ITEM_KAK_MALO_RED_POTION,
        SHOP_ITEM_KAK_GORON_OIL,
        SHOP_ITEM_KAK_GORON_RED_POTION,
        SHOP_ITEM_KAK_GORON_BLUE_POTION,
        SHOP_ITEM_BARNES_BOMB,
        SHOP_ITEM_BARNES_WATER_BOMB,
        SHOP_ITEM_BARNES_BOMB_INSECT,
        SHOP_ITEM_MOUNTAIN_GORON_OIL,
        SHOP_ITEM_MOUNTAIN_GORON_WOOD_SHIELD,
        SHOP_ITEM_MOUNTAIN_GORON_MILK,
        SHOP_ITEM_MOUNTAIN_GORON_ARROW,
        SHOP_ITEM_CASTLE_MALO_RED_POTION,
        SHOP_ITEM_CASTLE_MALO_BLUE_POTION,
        SHOP_ITEM_CASTLE_MALO_ARROW,
        SHOP_ITEM_CASTLE_MALO_BOMB,
        SHOP_ITEM_CASTLE_MALO_WATER_BOMB,
        SHOP_ITEM_CASTLE_MALO_BOMB_INSECT,
        SHOP_ITEM_CASTLE_MALO_MAGIC_ARMOR,
        SHOP_ITEM_CITY_BOMB,
        SHOP_ITEM_CITY_RED_POTION,
        SHOP_ITEM_CITY_ARROW,
        SHOP_ITEM_CITY_BLUE_POTION,
        SHOP_ITEM_CITY_OIL,
        /*SHOP_ITEMNO_OIL,
        SHOP_ITEMNO_RED,
        SHOP_ITEMNO_MILK,
